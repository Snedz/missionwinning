...
| Path | Role |
|------|------|
| `src/pages/` | Routes. One `.astro` file per URL — `index.astro` (homepage), `start.astro` (conversion), `week.astro` (dedicated landing), `about.astro` (commissioned about; Next keeps the host and Next `/about`) |
