...
## 2026-08-13 — Five-event field test + published-table score (`.708`)
...
Label `.708` (past master `.697`; reserved `.698`–`.707` left alone).

Excellence-Override: free five-event field test (logger)

Rotated LOG oldest → [docs/archive/log/LOG-rotate-669-for-708.md](docs/archive/log/LOG-rotate-669-for-708.md).
