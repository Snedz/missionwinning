...
## 2026-08-12 — Free Learn intro — offline Train + Coach from logs (`.699`)
...
Label `.699` (onto master `.697`; `.698` claimed by #477). Excellence-Override below.

Excellence-Override: CoS-approved refine-only Learn free intro (wedge CTAs; no phone excellence claim)
