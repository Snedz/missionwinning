...
coverage stays at 0. Label `.713` (does not steal #488 `.712`). Receipt PR honor is `text-primary` (small red).

Excellence-Override: Victory vs-last receipt (free, offline)

Rotated LOG oldest → [docs/archive/log/LOG-rotate-669-for-713.md](docs/archive/log/LOG-rotate-669-for-713.md).
