...
## 2026-08-13 — Learn original Super Bundle sequence (`.705`)

Premium Learn depth so Super Bundle beats a guidebook + Strong + a coach app:
original Ch11 **One Week, One Sequence** and Ch12 **One Stack** (Diataxis tutorial /
how-to / explanation / reference). Train → Coach → Fuel/Move/Mind as one week,
not six apps. Free intro stays free (no edits to Ch3/Ch4, `sb-0`, `pd-0`, magazine).
Originality logged. Inventory 16→24 sections.

Frozen plan: [docs/LEARN_SUPER_BUNDLE_PLAN.md](docs/LEARN_SUPER_BUNDLE_PLAN.md).

Excellence-Override: Learn original Super Bundle depth
