...
## 2026-09-18 — Mission HOME / Program 67 RedNote 适我主义 pack (`.1111`)

Public-safe loft pattern
notes at `mission-home/`.
CoS / Founder rooms: coffee
fuel wall, spiral stair,
island, library, shoe closet,
sliding wardrobe. STEAL/SKIP
for 适我主义, 去家务化动线,
容乱区, 能量场, 早C岛台.
Materials: oak, limewash,
brass, soapstone, 2700K.
Chinese + EN RedNote query
seeds. Not a shop. No
checkout links. No invented
prices. No camera shopping.
No invented contractor hours.

Lock: `missionHomePack.test.ts`
discovers `mission-home/*.md`
(unreviewed file red; stale
name red) and pins README
`##` headings.

**Mutants killed:** drop
`## Island`; add
`paymentUrl=`; drop a fifth
unreviewed `.md`.
