...
## 2026-08-13 — Stamp public version Mission Winning 0.1 (beta) (`.700`)
...
Coach from logs. Did not flip `PRIVATE_MODE` or unmute `FREE_BETA`. Label `.700`
(skips #477 `.698` / #478 `.699`).
