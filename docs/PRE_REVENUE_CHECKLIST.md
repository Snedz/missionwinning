...
**Gate:** Do not charge the first Super Bundle customer until every **Required** row is done. Optional rows can wait days, not months, once volume grows.
...
| Done | Item |
|------|------|
| ⬜ | LLC formed (default: home state — [ENTITY_RESEARCH.md](legal/ENTITY_RESEARCH.md)) |
| ⬜ | EIN obtained |
...
| ⬜ | Formation **state** written into `/terms` governing law (replace placeholder) |
...
| Done | Item |
|------|------|
| ⬜ | Stripe account under LLC + live Checkout / Payment Links |
