...
|------|----------|-------|--------------|
| 2026-08-15 | Gauntlet GNT-1.U3 R2 | Coach + Today two-history week | PASS. Engine 2/2. Render spec 2 passed. Stills `U3-R2-coach-history-a/b` + `U3-R2-today-history-a/b`: strength week vs mixed+mobility. |
