...
|------|----------|-------|--------------|
| 2026-08-15 | Gauntlet GNT-1.U4 R2 | `/log` missed-3 · missed-7 · missed-14 | Quiet line on Today dock (not `/private`). Stills `U4-R2-missed-{3,7,14}.png`. `reentryCopyGuard` 5/5. Render spec 3 passed. |
