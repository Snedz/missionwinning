...
5. Finish — your session saves to **History**. Victory is a quiet receipt: duration, volume, sets, and vs last time when you have done the same lifts before. A first session has no invented PR. If you skip a planned Coach day, Today offers do it now, skip, or slide — skip is not a fail.
