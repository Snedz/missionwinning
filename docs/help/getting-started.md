...
3. Log sets (reps, weight, RPE). Each incomplete set shows a **Target** stacked above **Previous**, cited from your last session (for example *from last Tue · sets 2–4*). Rest timer runs automatically.
