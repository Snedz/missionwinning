...
- **History** — past sessions (date, muscles, set count); tap a row to open that log and edit the sets you logged, then Save. Confirm before a destructive change. Empty invents nothing. You can also delete that one finished session after confirm — it cannot be recovered. Other days stay.
