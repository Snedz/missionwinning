...
**Next spawn:** CRITIC on **U2 R1** — instrument green locally. Evidence trio: 390×844 (medallion on disk + Victory if you can earn Week One, or the SVG itself) · stills under `docs/gauntlet/VISION/evidence/` · pasted `badgeIcons.test.ts` last lines.
