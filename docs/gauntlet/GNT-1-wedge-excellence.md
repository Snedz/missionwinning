...
**Next spawn:** `BUILDER · GNT-1 U3 R2` — U2 stopped (written `/log` instruments PASS; budget 2 used). Oldest FAIL is U3. Brief = U3 R1 gap only: Two-history render on `/coach` + `/log` is unproven.
