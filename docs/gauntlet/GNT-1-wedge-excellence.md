...
**Next spawn:** `BUILDER · GNT-1 U4 R2` — U3 stopped (engine + two-history render PASS). Oldest FAIL is U4. Brief = U4 R1 gap only: Quiet line after 3/7/14 days is unproven on-screen.
