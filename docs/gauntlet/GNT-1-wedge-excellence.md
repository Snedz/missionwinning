...
**Next spawn:** `BUILDER · GNT-1 U2 R2` — U1 stopped (written instruments PASS; budget 3 used). Oldest FAIL is U2. Brief = U2 R1 gap only: Cold `/log` e2e is not on Today (1 red vs grey-Just-Go cap 0).
