Superseded live LOG section rotated 2026-09-18 for `.1111` Mission HOME / Program 67 public-safe loft pack.
...
Rotated LOG oldest → [docs/archive/log/LOG-rotate-1081-for-1096.md](LOG-rotate-1081-for-1096.md) (`.1081`).
