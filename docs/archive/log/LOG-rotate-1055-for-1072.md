Superseded live LOG section rotated 2026-09-14 for `.1072` Mission OS capability interfaces.
...
Rotated LOG oldest → [docs/archive/log/LOG-rotate-1038-for-1055.md](./LOG-rotate-1038-for-1055.md).
