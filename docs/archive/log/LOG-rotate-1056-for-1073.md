Superseded live LOG section rotated 2026-09-14 for `.1073` Health mini stub mount.
...
Rotated LOG oldest → [docs/archive/log/LOG-rotate-1039-for-1056.md](LOG-rotate-1039-for-1056.md).
