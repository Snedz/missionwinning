# Rotated LOG entry — `.756` (for `.772`)

Superseded in live [LOG.md](../../../LOG.md) when `.772` shipped.
...
Rotated LOG oldest → [docs/archive/log/LOG-rotate-697-for-756.md](LOG-rotate-697-for-756.md).
