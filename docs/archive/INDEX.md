...
| [log/LOG-2026-07-31_to_2026-08-01.md](./log/LOG-2026-07-31_to_2026-08-01.md) | 13 entries (`.214`–`.224`, `.244`–`.245`: the note nobody could read, the streak that never breaks, a security check that can actually fail, the design rules nothing checked, take the weight out, the gate that could not go green, the column that hid four more controls, the charts the guard could not see, the day a session lands on) — rotated 2026-08-02 when the `.244`–`.251` wave merged alongside `.240`–`.243` and the live file went 23 entries over; `.222` joined it when `.252` merged |
