...
| [log/LOG-2026-07-31_to_2026-08-01.md](./log/LOG-2026-07-31_to_2026-08-01.md) | 10 entries (`.214`–`.223`: the note nobody could read, the streak that never breaks, a security check that can actually fail, the design rules nothing checked, take the weight out, the gate that could not go green) — rotated 2026-08-02 when the `.244`–`.251` wave merged alongside `.240`–`.243` and the live file went 23 entries over |
