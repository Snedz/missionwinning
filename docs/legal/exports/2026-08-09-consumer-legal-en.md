...
**Source:** `src/i18n/infoLocales.ts`

## Territory (founder policy)

- Europe (EEA/UK/CH/FR+), Canada, **Ukraine**, OIC 57 — hosted service not offered.
- Ukraine is a **commercial** exclusion, not an OFAC comprehensive country embargo of free Ukraine.
- Russia / Belarus remain open in product logic (founder asymmetry — counsel review recommended).
- Product code: `src/lib/legal/supportedRegions.ts`.

## Live URLs

`/terms` · `/privacy` · `/usage` · `/regions` · `/service-terms` · `/refunds` · `/dmca`
...
### Usage prohibited (territory/sanctions)
...
## Counsel still recommended

Arbitration enforceability; UA-only vs RU open; sanctions clause scope; DMCA interim; postal address.
