...
ticket: leftover-hard-session-not-care-cite
done_means: Hard-session not-care cite under .mw-house is house leftover (--house-muted / house-lede), not text-muted-foreground. Stop / emergency / clinician stay. Confirm stays outline. Portals stay mw-house. Copy unchanged.
accept: npx tsx --test src/lib/hardSessionNotCareCite.test.ts
test_written: yes
...
- One leftover: Hard-session not-care cite is house leftover.
...
- Hard-session lead cite / Check-in lead / Swap garage / another-movement / Form guide ready-cite stay done. Do not reopen.
