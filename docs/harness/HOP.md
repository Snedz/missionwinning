...
ticket: leftover-set-kind-chip-row
done_means: Train first-paint kind chip row is house leftover, not text-muted. Finish / Skip / Swap / Form guide / Repeat* never house-btn-primary.
accept: npx tsx --test src/lib/workout/setTableKindChipRow.test.ts
test_written: yes
...
- One leftover: Kind chip row is house leftover.
