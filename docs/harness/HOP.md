...
ticket: leftover-account-calculators-body-cite
done_means: Account more-settings calculators body cite is house leftover, not text-muted. Calculators door stays ghost. Finish / Skip / Swap / Form guide / Repeat* never house-btn-primary.
accept: npx tsx --test src/lib/accountCalculatorsBodyCite.test.ts
test_written: yes
...
- One leftover: Account more-settings calculators body cite is house leftover.
- Calculators door stays ghost. Do not restyle to house-btn-primary.
