...
ticket: leftover-you-athlete-badges-legend
done_means: You athlete card badges legend cite is house leftover, not text-muted. Badge buttons stay outline. Finish / Skip / Swap / Form guide / Repeat* never house-btn-primary.
accept: npx tsx --test src/lib/youAthleteBadgesLegendCite.test.ts
test_written: yes

## progress

Honesty was red (3 fail / 1 pass). Chrome. Accept pass. Walk 1280: /log → Start → /active → History. Badges legend unmounted on guest — source leftover holds. Badge buttons stay outline.

## decisions

- One leftover: You athlete card badges legend cite is house leftover.
- Badge buttons stay outline / selected. Do not restyle to house-btn-primary.
- Badges preview cite stays later.
