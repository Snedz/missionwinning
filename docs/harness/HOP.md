...
Honesty was red (3 fail / 1 pass). Chrome. Accept pass. Walk 1280: /log → Start → /active → History. Private note textarea house-field 1px --house-line after opening the disclosure. Save stays outline.
