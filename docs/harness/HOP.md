...
ticket: leftover-coach-group-loading
done_means: Nav to /coach does not paint the app-group Loading skeleton. Segment loading is house leftover, not SkeletonCard and not a page import. Finish / Skip / Swap / Form guide / Repeat* never house-btn-primary.
accept: npx tsx --test src/lib/coach/coachGroupLoading.test.ts
test_written: yes
...
- One leftover: /coach nav is not group Loading.
