...
**Overnight leftover (2026-08-13):** Specialists landed (#497 Move, #499 Fuel, #501 Mind `.707`, #502 Learn, #498 shop). Do not collide. Implement [SUPER_BUNDLE_SHOP_HONESTY_PLAN.md](SUPER_BUNDLE_SHOP_HONESTY_PLAN.md) only (Move table counts + Train why + vs-stack help — label `.710`).
