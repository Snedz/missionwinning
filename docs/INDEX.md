...
| [GRAPH_LOOP.md](GRAPH_LOOP.md) | Harness execution queue — live row from `npm run harness`, never restated here |
| [harness/INDEX.md](harness/INDEX.md) | Live hop contract (`HOP.md`) + compaction pin (`PINNED.md`). Closer: `npm run harness:done` |
...
| [DEPENDABOT_BATCH_1067.md](DEPENDABOT_BATCH_1067.md) | Leftover Dependabot batch (paper stays `.1066`) — take playwright + posthog + supabase/ssr + i18next; hold stripe; skip eslint 10 |
...
| [IA_SKELETON.md](IA_SKELETON.md) | CoS freeze — three loops + named rooms; official catalog = Library + Builder; isolation proofs |
| [FLOW_ARCHITECTURE.md](FLOW_ARCHITECTURE.md) | Chip floorplan — dies, buses, critical path, dual pads |
