...
**Status:** ACTIVE 2026-08-15 · web `2026.07-unified.849` · Alpha 0.1.0 · **AL1 done — GNT-1 `ready-for-founder` · AM1 open — GNT-2 U4 R1 instrument `.849`, critic next**  
...
| # | Loop | Moves | Status |
|---|------|-------|--------|
| **AM1** | Gauntlet GNT-2 coach plan quality | [docs/gauntlet/GNT-2-coach-plan-quality.md](gauntlet/GNT-2-coach-plan-quality.md). U1–U3 closed (engine). U4 instrument `.849` (`coachEvalGear.test.ts`). Next spawn is the workbench CRITIC U4 R1 line | `open` |
