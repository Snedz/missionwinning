...
**Status:** ACTIVE 2026-08-15 · web `2026.07-unified.846` · Alpha 0.1.0 · **AL1 done — GNT-1 `ready-for-founder` · AM1 open — GNT-2 U2 LEAD commissioned the instrument; BUILDER R1 next**  
...
| # | Loop | Moves | Status |
|---|------|-------|--------|
| **AM1** | Gauntlet GNT-2 coach plan quality | [docs/gauntlet/GNT-2-coach-plan-quality.md](gauntlet/GNT-2-coach-plan-quality.md). U1 closed (engine). U2 bar written: last-session easy RPE must raise load at `generateWeek`; week shape is U1. Next spawn is the workbench BUILDER U2 R1 line | `open` |
