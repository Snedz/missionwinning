...
export const MAGAZINE_META = {
  ...
  howToUse: [
    'Read a section when you want the why behind a lift, a deload, or a Coach week.',
    'When you see a practice line, open that route and do one small action — preferably log a set. Mission Coach builds weekly plans from those logs alone (no wearable).',
    'Read start to finish, or jump to what you are stuck on. The app is the experience (Train + Coach first); this magazine is the reference.',
  ],
  preface: [
    ...
    'Mission Winning is built the same way. The free logger is where you train; Mission Coach turns those logs into fatigue-aware weekly plans — no wearable required. This magazine is where you learn what adaptation is, how movement patterns work, how to tune volume and intensity, and how nutrition and sleep close the loop.',
