...
const EXERCISE_ENTRIES: Exercise[] = [
  ...
  { id: "hand-release-push-up", name: "Hand-release push-up", muscleGroups: ["Chest", "Arms", "Core"], equipment: "Bodyweight", cues: "Chest to floor, lift hands, press up. Count reps in two minutes." },
  { id: "sprint-drag-carry", name: "Sprint-drag-carry", muscleGroups: ["Full Body", "Legs"], equipment: "Sled", cues: "25 m lane: sprint, sled drag, lateral, farmer carry, sprint. Log finish time in seconds." },
  { id: "field-shuttle-carry", name: "Shuttle + farmer carry", muscleGroups: ["Full Body", "Legs"], equipment: "Dumbbells", cues: "Garage stand-in: shuttle runs plus farmer carry. Not the sled event — unscored on the field test." },
  { id: "two-mile-run", name: "2-mile run", muscleGroups: ["Cardio", "Legs"], equipment: "Bodyweight", cues: "Road or treadmill. Log finish time in seconds." },
