...
| `BuilderPage.tsx` | `/builder` | Builder first paint is house leftover. Write side of the official training catalog. First paint is Blank workout; program templates in Show all. Builder Show-all door is house leftover. Builder Show all extras is house leftover (fold chrome only — ProgramTemplatesPanel internals stay). Offline program shell (weeks → suggested sets) stays in that fold; Start opens Train. Not a shop. |
