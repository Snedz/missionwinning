...
| File | Route |
|------|-------|
| `ProfilePage.tsx` | `/profile` — You leftover; first paint is house leftover (static import, no `RouteLoading`). You first-paint identity card is house leftover. You first-paint athlete card is house leftover. You first-paint table card is house leftover. Identity / kit first; Account door is house-btn ghost |
