...
| `LibraryPage.tsx` | `/library` | Official exercise catalog. First paint is a pick list; posters / templates in Show all. Duplicate names can be merged (`.1002`). A name can be hidden from Add / search (`.1004`). |
