...
| `FlagsConsolePage.tsx` | `/account/flags` — Flags console first paint is house leftover (static page, not RouteLoading). Founder staged rollouts. Closed catalog. Never a nav tab. |
