...
| History row | `.house-item` in `.house-history` | Hairline list. Open log; Again / Details ghost. History tools are house leftover. History search is house leftover. History Show all extras is house leftover. History day leftover is the open day (kicker + date + that day's rows; Repeat is house-btn ghost). Calendar / charts / posters stay parked. |
