...
| Catalog row | `.house-item` in `.house-catalog` | Hairline list. Pick mark + name + details. Library Filters is house leftover. Library Filters sheet is house leftover. Library detail is house leftover. Library hidden is house leftover. |
| History row | `.house-item` in `.house-history` | Hairline list. Open log; Again / Details ghost. History tools are house leftover. |
