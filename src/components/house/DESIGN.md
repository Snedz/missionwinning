...
| Fuel leftover | `.house-fuel` | Log stays first paint. Fuel first-paint notepad is house leftover. Recents are house-state. Type field is house-field. Water is house-btn, not filled. Search / barcode / recipes stay in Show all. Today's meals card stays. |
