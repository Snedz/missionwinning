...
| Quiet More | `.house-move` `.house-mind` `.house-track` `.house-learn` | Quiet title stays. Move first-paint flow list is house leftover. Track first-paint metrics is house leftover. Mind first-paint check-in is house leftover. Mind first-paint breathe is house leftover. Start / Pause / Reset are house-btn, not filled. Pattern chips are house-state; selected `#eee`. Learn first-paint intro is house leftover. Extra tools in house-card Show all |
