...
| Quiet More | `.house-move` `.house-mind` `.house-track` `.house-learn` | Quiet title stays. Move first-paint flow list is house leftover. Track first-paint metrics is house leftover. Mind first-paint check-in is house leftover. Save is house-btn-primary, not `--accent-poster`. Scale ticks are ink, not red. Behavior strip / breathe / sessions stay. Learn first paint unchanged. Extra tools in house-card Show all |
