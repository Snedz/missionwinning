...
| Catalog row | `.house-item` in `.house-catalog` | Hairline list. Pick mark + name + details. Library Filters is house leftover. Library Filters sheet is house leftover. |
