...
| `HouseFirstRoomsCard.tsx` | Persistent collapsible N-of-N under Start. Three MW rows. First-rooms Log a set is `href="/active"`. First-rooms History is `href="/history"`. |
