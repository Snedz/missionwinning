...
| File | Purpose |
|------|---------|
| `ActiveEmptyState.tsx` | No-session shell — Start workout (honest empty; Just Go stays on I-Day) |
...
| `WorkoutVictorySheet.tsx` | Post-workout summary — `AdaptiveOverlay` (`z-[70]`), honor next in pinned `footer` |
