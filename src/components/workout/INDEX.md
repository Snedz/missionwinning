...
| `ActiveSessionChrome.tsx` | Session bar — name, compact elapsed · sets, Finish. No Live session eyebrow. Plates + coach tip in overflow. Compact Add exercise is after the table |
