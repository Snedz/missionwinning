      ...
      {suggestions.map((s) => {
        ...
        return (
          <Link
            ...
            href={path}
            className="inline-flex items-center border border-primary bg-tint px-3 py-1 text-xs font-semibold text-primary hover:bg-primary hover:text-primary-foreground transition-colors"
            title={actionLabel}
          >
            {message} →
          </Link>
