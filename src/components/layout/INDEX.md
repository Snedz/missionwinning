...
| `Sidebar.tsx` | Left room rail — Today · Train · Coach · History · Library; You + More in the foot. Visible on the athlete shell at every width. Athlete chip is public version |
| `MobileNav.tsx` | Compact bottom dock — cold Summary + Search; live Train joins. Room map is the left rail. In flow (not fixed) so it reserves its own height. Rooms: [docs/IA_SKELETON.md](../../../docs/IA_SKELETON.md) |
