...
- **Tests to run:** `src/lib/mission-os/fakes.test.ts`, `src/lib/mission-os/host.test.ts`, `src/lib/mission-os/health.test.ts`, `src/lib/mission-os/clearshot.test.ts`, `src/lib/mission-os/mountIsolation.test.ts`, `src/lib/mission-os/deeplink.test.ts`, `src/lib/mission-os/billing.test.ts`, `src/lib/mission-os/photos.test.ts`, `src/lib/mission-os/listMounted.test.ts`, `src/lib/mission-os/identity.test.ts`, `src/lib/mission-os/storage.test.ts`, `src/lib/mission-os/allow.test.ts`, `src/lib/mission-os/call.test.ts`, `src/lib/mission-os/alreadyMounted.test.ts`, `src/lib/mission-os/unknownMini.test.ts`, `src/lib/mission-os/notMounted.test.ts`, `src/lib/mission-os/callNotMounted.test.ts`, `src/lib/mission-os/deeplinkUnknownMini.test.ts`, `src/lib/mission-os/deeplinkBadDeeplink.test.ts`, `src/lib/mission-os/dualMountStorage.test.ts`, `src/lib/mission-os/dualMountIdentity.test.ts`, `src/lib/mission-os/dualMountBilling.test.ts`, `src/lib/mission-os/dualMountPhotos.test.ts`, `src/lib/mission-os/unknownCapability.test.ts`, `src/lib/mission-os/storageCap.test.ts`, `src/lib/mission-os/denyCodes.test.ts`, `src/lib/mission-os/storageCapRemount.test.ts`, `src/lib/mission-os/storageRemove.test.ts`, `src/lib/minisIsolation.test.ts`
...
| `PLAN.md` | `.1100` storage.remove CapResult consistency claim |
...
| `deeplink.ts` | Last-segment `clearshot` → `utility.clearshot` mount; unknown last-segment is `unknown_mini`; malformed / non-minis is `bad_deeplink` |
