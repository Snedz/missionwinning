...
- **Entry files:** `types.ts`, `fakes.ts`, `host.ts`, `health.ts`, `clearshot.ts`, `deeplink.ts`, `call.ts`, `billingProbe.ts` (test-only), `identityProbe.ts` (test-only), `storageProbe.ts` (test-only), `allowProbe.ts` (test-only)
- **Tests to run:** `src/lib/mission-os/fakes.test.ts`, `src/lib/mission-os/host.test.ts`, `src/lib/mission-os/health.test.ts`, `src/lib/mission-os/clearshot.test.ts`, `src/lib/mission-os/mountIsolation.test.ts`, `src/lib/mission-os/deeplink.test.ts`, `src/lib/mission-os/billing.test.ts`, `src/lib/mission-os/photos.test.ts`, `src/lib/mission-os/listMounted.test.ts`, `src/lib/mission-os/identity.test.ts`, `src/lib/mission-os/storage.test.ts`, `src/lib/mission-os/allow.test.ts`, `src/lib/mission-os/call.test.ts`, `src/lib/mission-os/alreadyMounted.test.ts`, `src/lib/minisIsolation.test.ts`
...
| `PLAN.md` | `.1086` MiniHost mount-duplicate refuse claim |
| `call.ts` | String-dispatch `callDoor` — deny-before-unknown, then closed-method check |
