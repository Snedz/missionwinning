...
> One concern: past-session facts for `/history` — month marks, the session list, find-a-past-session search (`.1008`), export this diary (`.1011`), and import that file back (`.1013`).
...
5. `monthGrid.ts` — calendar marks (trained / logged / blank; never “missed”)
6. `historySheetChrome.test.ts` — list first; calendar / charts / journal in Show all
