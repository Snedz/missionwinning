...
test('SetLogRow: metric-first density; no prose console chrome; 44px taps', () => {
...
test('SetLogTable: one poster-red Log set; 44px inputs; completed cues', () => {
...
test('RestTimerBar: Skip testid + 44px; accent fill only on final path', () => {
