...
1e. `setRowType.ts` — open row speaks weight · bodyweight reps · duration · assisted (`.994`). Empty / custom stays weight×reps. Vest is extra only. Live Next/Last cites reuse this grammar (`.1009` BW, `.1014` hold `0:45`, `.1015` assisted 0 → BW not `0 kg`).  
