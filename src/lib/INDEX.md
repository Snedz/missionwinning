...
| **Gated www honesty** | `gatedWwwHonesty.ts` | F-008 / old `.698` — EN Free / Enter with code / Get notified on the gated door. Public line: Log a set. Offline. Support: No account. No wearable. Build `.931`. |
