...
| **First-set ungated** | `firstSetUngated.ts` | F-017 / `.766` + `.762` + `.941` — `showHeaderSignInChip`. Hide Sign in until the first workout; never on `/active`. Guest `SIGNED_OUT` does not wipe the local log. |
