...
| **Mission OS minis** | [`minis/`](minis/INDEX.md), [`mission-os/`](mission-os/INDEX.md), `minisIsolation.test.ts` | Function bus (`createMiniBus`, #935) + named doors + in-memory fakes (`MiniHost.mount`, `.1072`). ClearShot reserved at `mission://minis/clearshot`. No Today/Train UI. Isolation: coach / store / HomePage / ActiveWorkout stay blind. |
