/**
 * Form guide breath cite is house leftover — house-lede, not an unpainted p.
 * Ready-position leftover stays. Got it stays outline. Copy stays.
...
test('Form guide breath cite is house leftover, not an unpainted p', () => {
  ...
  assert.match(sheet, /house-card house-form-breath/);
});
...
test('house leftover rule paints form-guide breath cite with --house-muted', () => {
...
test('DESIGN names Form guide breath cite is house leftover', () => {
