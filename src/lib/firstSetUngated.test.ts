...
describe('firstSetUngated wiring', () => {
  ...
  it('trained day session count stays ungated (.1032)', () => {
    const src = read('src/lib/firstSetUngated.ts');
  ...
  it('replace a lift on a finished session stays ungated (.1036)', () => {
    const src = read('src/lib/firstSetUngated.ts');
    assert.match(src, /`\.1036` — replace a lift on a finished History session/);
  });

  it('add a lift to a finished session stays ungated (.1037)', () => {
    const src = read('src/lib/firstSetUngated.ts');
    assert.match(src, /`\.1037` — add a lift to this finished History session/);
  });

  it('remove this lift from a finished session stays ungated (.1038)', () => {
    const src = read('src/lib/firstSetUngated.ts');
  ...
  it('RPE on a finished set stays ungated (.1040)', () => {
    const src = read('src/lib/firstSetUngated.ts');
    assert.match(src, /`\.1040` — RPE on a finished History set/);
  });

  it('RIR on a finished set stays ungated (.1041)', () => {
    const src = read('src/lib/firstSetUngated.ts');
  ...
  it('load % on a finished set stays ungated (.1044)', () => {
    const src = read('src/lib/firstSetUngated.ts');
  ...
  it('superset on a finished session stays ungated (.1047)', () => {
    const src = read('src/lib/firstSetUngated.ts');
