/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.1111` Craft: Fuel help FAQ honesty — edit-before-log, vision-vs-heuristic, restock does not order, not clinical. */
