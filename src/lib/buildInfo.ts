/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.1011` Export this diary (from master `.1010` Library skips deleted sessions `4d128292d`; stamp stays `.1011`; keep library skip `.1010` + BW cite `.1009` + search `.1008`). */
