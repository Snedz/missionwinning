/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.959` skip / swap this session (past master `.958`). */
export const APP_BUILD_LABEL = "2026.07-unified.959";
