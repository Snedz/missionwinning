/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.1112` Craft: year of logged days on History, from workoutHistory. Blank is not missed. */
