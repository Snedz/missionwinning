/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.958` desk → gym one session (past master `.957`). */
export const APP_BUILD_LABEL = "2026.07-unified.958";
