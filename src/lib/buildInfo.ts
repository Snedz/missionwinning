/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.850` GNT-2 U4 instrument. */
export const APP_BUILD_LABEL = "2026.07-unified.850";
