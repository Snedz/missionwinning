/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.1063` CI source guards ↔ house desk; paper only; do not promote; live www stays `.697`; PRIVATE_MODE stays; [skip vercel]. */
