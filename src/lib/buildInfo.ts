/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.957` tight /private lock (past master `.956`). */
export const APP_BUILD_LABEL = "2026.07-unified.957";
