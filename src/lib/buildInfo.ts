/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.1075` PathShell, not House (from `.1074` `543823f4`; visual/do-not-merge; do not promote). */
