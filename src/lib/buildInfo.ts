/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.954` Today return path (past master `.953`). */
export const APP_BUILD_LABEL = "2026.07-unified.954";
