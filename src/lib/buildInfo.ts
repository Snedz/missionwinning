/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.998` Live session reorder (past master `.997` Edit a finished session `bb13642b`; keep History Edit `.997` + note+pin `.996` + rest `.995` + set-row type `.994` + history `.993` + custom `.992` + Start this again `.991` + Track trend `.989` + EMOM `.988` + drop-set `.986` + warmup `.985` + notes `.983` + 1RM `.981` + supersets `.980` + Learn `.978` + honesty `.971` + tags `.970` + RPE `.967` + Fuel `.965` + resume `.963` + notebook `.960`). */
export const APP_BUILD_LABEL = "2026.07-unified.998";
