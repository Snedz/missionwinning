/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.1067` next 16.3.4 AVIF re-enable / sharp 0.35.4 follow-up; paper only; do not promote; live www stays `.697`; PRIVATE_MODE stays; [skip vercel]. */
