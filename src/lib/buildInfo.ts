/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.845` GNT-2 U1 loadZone split. */
export const APP_BUILD_LABEL = "2026.07-unified.845";
