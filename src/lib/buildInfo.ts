/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.906` client writes close. */
export const APP_BUILD_LABEL = "2026.07-unified.906";
