/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.1058` Train does not mint a Coach week (from master `.1057` `f302f40f`; visual/do-not-merge; do not promote). */
