/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.961` quiet week strip (past master `.960`). */
export const APP_BUILD_LABEL = "2026.07-unified.961";
