/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.960` honor the notebook (past master `.959`). */
export const APP_BUILD_LABEL = "2026.07-unified.960";
