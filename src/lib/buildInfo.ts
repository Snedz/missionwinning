/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.829` journal strip. */
export const APP_BUILD_LABEL = "2026.07-unified.829";
