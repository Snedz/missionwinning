/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.940` Strong CSV import (past master `.939`). */
export const APP_BUILD_LABEL = "2026.07-unified.940";
