/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.768` Legal footers stop prefetching the legal library on first paint. */
