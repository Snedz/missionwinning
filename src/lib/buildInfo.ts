/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.763` device-local kit; Just Go + Coach filter; Train empty Start stays repeat-last. */
export const APP_BUILD_LABEL = "2026.07-unified.763";
