/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.1064` Astro AVIF RCE (Dependabot #87 / GHSA-26w7-cxv4-gfx2); paper only; do not promote; live www stays `.697`; PRIVATE_MODE stays; [skip vercel]. */
