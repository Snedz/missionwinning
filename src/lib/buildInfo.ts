/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.776` Mission Server durable rooms. */
export const APP_BUILD_LABEL = "2026.07-unified.776";
