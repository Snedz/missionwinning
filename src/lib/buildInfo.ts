/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.1070` coverage floor 438→493 + bundle `/` 351 · `/log` 417 · `/active` 511 + a11y unique `/server` + Hero e2e house leftover selectors; paper only; do not promote; live www stays `.697`; PRIVATE_MODE stays; [skip vercel]. */
