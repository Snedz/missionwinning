/** Shown on Profile so testers can confirm the deployed build. Bump when shipping UI to master. `.818` Coach first paint. */
export const APP_BUILD_LABEL = "2026.07-unified.818";
