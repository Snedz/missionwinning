...
const LANDING_EN: Record<string, string> = {
  ...
  landingHeroTitle1: 'Log a set.',
  landingHeroTitle2: 'Offline.',
  landingHeroSubtitle:
  ...
  footerTagline: 'Log a set. Offline.',
  ...
  footerCompanyChangelog: 'Changelog',
