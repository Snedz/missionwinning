...
const LANDING_EN: Record<string, string> = {
  ...
  landingFinalCtaButton: 'Begin I-Day',
...
const LANDING_ES: Record<string, string> = {
  ...
  landingNavBundle: 'Super Bundle',
  landingNavStart: 'Comenzar I-Day',
  ...
  landingFinalCtaButton: 'Comenzar I-Day',
...
const LANDING_PT: Record<string, string> = {
  ...
  landingFinalCtaButton: 'Começar I-Day',
...
const LANDING_DE: Record<string, string> = {
  ...
  landingNavStart: 'I-Day beginnen',
  ...
  landingFinalCtaButton: 'I-Day beginnen',
...
const LANDING_FR: Record<string, string> = {
  ...
  landingNavStart: 'Commencer I-Day',
  ...
  landingFinalCtaButton: 'Commencer I-Day',
...
const LANDING_IT: Record<string, string> = {
  ...
  landingFinalCtaButton: 'Inizia I-Day',
  landingFinalCtaFoot:
...
const LANDING_RU: Record<string, string> = {
  ...
  landingFinalCtaButton: 'Начать I-Day',
  landingFinalCtaFoot:
...
const LANDING_KO: Record<string, string> = {
  ...
  landingFinalCtaButton: 'I-Day 시작',
  landingFinalCtaFoot:
...
const LANDING_JA: Record<string, string> = {
  ...
  landingFinalCtaButton: 'I-Dayを始める',
  landingFinalCtaFoot:
...
const LANDING_HI: Record<string, string> = {
  ...
  landingNavStart: 'I-Day शुरू करें',
  landingNavHome: 'होम',
  ...
  landingFinalCtaButton: 'I-Day शुरू करें',
...
const LANDING_ID: Record<string, string> = {
  ...
  landingFinalCtaButton: 'Mulai I-Day',
...
const LANDING_TH: Record<string, string> = {
  ...
  landingFinalCtaButton: 'เริ่ม I-Day',
...
const LANDING_ZH: Record<string, string> = {
  ...
  landingFinalCtaButton: '开始 I-Day',
...
const LANDING_VI: Record<string, string> = {
  ...
  landingFinalCtaButton: 'Bắt đầu I-Day',
...
const LANDING_AR: Record<string, string> = {
  ...
  landingFinalCtaButton: 'ابدأ I-Day',
