...
const en: InfoStrings = {
  ...
  infoRegionsNotSupportedBody:
    'We do not support: (1) Europe — EEA, United Kingdom, Switzerland, France, and associated territories; (2) Canada; (3) Ukraine; (4) all 57 Organisation of Islamic Cooperation member states. Do not create a hosted account, purchase Super Bundle, or expect customer support if you reside there. Signup and checkout are hard-blocked in-app when your CDN country matches these lists (in addition to Cloudflare). We do not appoint an EU/UK GDPR representative for this consumer offering. Separately, U.S. sanctions and export control law may forbid providing the Service in comprehensively embargoed jurisdictions and to other persons or destinations restricted under applicable U.S. sanctions or export control programs. We may refuse, suspend, or terminate access for legal compliance even when automated country detection is imperfect. See Terms — Sanctions, export controls & prohibited persons.',
  ...
  infoServiceRegionsBody:
    'All service lines above that depend on Mission Winning LLC hosting, accounts, or payments are limited to Supported Regions. Europe, Canada, Ukraine, and OIC member states are not supported. See /regions. Independently of commercial Supported Regions, U.S. sanctions and export controls may forbid service in comprehensively embargoed jurisdictions and to other persons or destinations restricted under applicable U.S. sanctions or export control programs — see Terms — Sanctions, export controls & prohibited persons.',
