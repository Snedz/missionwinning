...
const NOTIFICATION_EN: Record<string, string> = {
  ...
  profileFreeBetaFoot: 'Free beta — full tools free while we grow with you. Logger stays free forever.',
  ...
  profileAssessmentFootOpenBeta:
    'Core free forever. Free beta unlocks history depth and deeper coaching tools.',
