...
type FuelStrings = {
  ...
  /** This week's restock they take (.965). */
  fuelRestockTitle: string;
  fuelRestockEmpty: string;
  fuelRestockHint: string;
  fuelRestockTypedLabel: string;
  fuelRestockTypedPlaceholder: string;
  fuelRestockCopy: string;
  fuelRestockCopied: string;
  fuelRestockCopyFailed: string;
  fuelRestockDownload: string;
  fuelRestockTimes: string;
  fuelRestockCount: string;
  fuelRestockYouShop: string;
};
...
const en: FuelStrings = {
  ...
  fuelRestockTitle: "This week's restock",
  fuelRestockEmpty: 'Log meals this week, or type what you need. Empty invents nothing.',
  fuelRestockHint: "From this week's Fuel log. Copy it. You shop. We do not order.",
  fuelRestockTypedLabel: 'Add what you need',
  fuelRestockTypedPlaceholder: 'eggs, oats, chicken…',
  fuelRestockCopy: 'Copy list',
  fuelRestockCopied: 'Copied',
  fuelRestockCopyFailed: 'Copy failed — select the list.',
  fuelRestockDownload: 'Download list',
  fuelRestockTimes: '×{{count}}',
  fuelRestockCount: '{{count}} items',
  fuelRestockYouShop: 'You shop. We do not order.',
};
