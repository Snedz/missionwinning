...
type TodayStrings = {
  ...
  coachInsightFuelCoachSynergy: string;
...
const es: TodayStrings = {
  ...
  coachActionOpenLearn: 'Abrir cursos Learn',
  coachActionOpenFuel: 'Abrir Fuel Coach',
...
const id: TodayStrings = {
  ...
  coachActionOpenFuel: 'Buka Fuel Coach',
  todayEditToday: 'Edit Today',
...
const th: TodayStrings = {
  ...
  coachActionOpenFuel: 'เปิด Fuel Coach',
...
const ar: TodayStrings = {
  ...
  todaySectionWeek: 'هذا الأسبوع',
  todaySectionWeekDesc: 'التحديات والتدريب اليومي',
  todayWeeklyChallenges: 'تحديات أسبوعية',
  todayWeeklyChallengesDesc: 'أهداف تدريب + تغذية + حجم هذا الأسبوع. مجاني — لا premium مطلوب.',
  todayDayStreak: 'سلسلة {{count}} أيام',
  todayStartWorkout: 'ابدأ تدريب اليوم',
  todaySectionProgress: 'التقدّم والأدوات',
  todaySectionProgressDesc: 'الجاهزية والإحصائيات والسجل',
  todayQuickOptions: 'خيارات سريعة',
  todayQuickOptionsDesc: 'برامج مجانية وروتينات محفوظة.',
  todayBuildCustom: 'إنشاء جلسة مخصصة ←',
  todayMuscleReadiness: 'جاهزية العضلات',
  todayMuscleReadinessDesc: 'بناءً على سجل التدريب الأخير. المجموعات الجاهزة للتركيز.',
  todayNoRecentData: 'لا بيانات حديثة',
  todayDaysRest: 'راحة {{days}} ي',
  todayTrainGroup: 'درّب {{group}} الآن ←',
  todayMuscleReadinessFoot: 'درّب المجموعات الجاهزة لأفضل النتائج. سجّل أكثر لذكاء أعلى.',
  todayRecommendedStart: 'نقطة البداية الموصى بها',
  todayRecommendedStartDesc: 'بناءً على إعداد مهمتك (عدّل في الملف).',
  todayFocusLabel: 'التركيز:',
  todayWithBodyweight: 'وزن الجسم/حد أدنى',
  todayWithEquipment: 'بمعدات متاحة',
  todayRecommendedBody: 'ابدأ من Builder أو قالب برنامج. أكمل الجلسات لرفع نقاط المهمة.',
  todayGoBuilder: 'إلى Builder / اختر قالب ←',
  todayStatSessions: 'جلسات',
  todayStatVolume: 'الحجم الكلي',
  todayStatSaved: 'روتينات محفوظة',
  todayStatStreak: 'السلسلة الحالية',
  todayStatDays: 'أيام',
  todayRecentWins: 'انتصارات حديثة',
  todayViewHistory: 'عرض السجل الكامل ←',
  todayYourWins: 'انتصاراتك وسلاسلك',
  todayYourWinsDesc: 'دليل على العمل الجاد. أكمل للشارات وأولوية المدرب.',
  ...
  fuelSignInDesc: 'مزامنة الوجبات والماكرو بين الأجهزة.',
  todayCustomizeTitle: 'تخصيص اليوم',
  todayCustomizeDesc: 'اختر الأقسام وترتيبها. يُحفظ على هذا الجهاز.',
  todayMoveSectionUp: 'تحريك لأعلى',
  todayMoveSectionDown: 'تحريك لأسفل',
  challengeTrain7Title: 'سلسلة تدريب 7 أيام',
  challengeTrain7Desc: 'سجّل تدريباً في 7 أيام مختلفة هذا الأسبوع.',
  challengeProtein5Title: '5 أيام بروتين عالي',
  challengeProtein5Desc: '120g+ بروتين في 5 أيام (ركيزة التغذية).',
  challengeVolume10kTitle: 'حجم 10K هذا الأسبوع',
  challengeVolume10kDesc: 'اجمع 10,000 حجم هذا الأسبوع.',
  photoLogProcessing: 'تقدير على الجهاز…',
  photoLogEstimateTitle: 'وجبة مقدّرة',
  photoLogEstimateLow: 'ثقة منخفضة — عدّل بعد التسجيل.',
  ...
  todayWinUnderStars: 'تحت النجوم ({{current}}/3 ليلاً)',
  todayWinDawn: 'بفجر النور ({{current}}/3 صباحاً)',
  todayWinBadgeFoot: 'سجّل الانتصارات يومياً — السلسلة والحجم يرفعان نقاط المهمة.',
  todayRankings: 'الترتيب',
  todayAssessmentCardTitle: 'آخر تقييم وانتصارات الركائز',
  todayAssessmentLast: 'آخر: مخاطر {{risk}} ({{date}})',
  todayAssessmentRetake: 'إعادة',
  todayAssessmentNone: 'لا تقييم بعد.',
  todayAssessmentTake: 'تقييم الجاهزية المجاني ←',
  ...
  coachActionOpenFuel: 'فتح Fuel Coach',
...
const LOCALES: Partial<Record<string, TodayStrings>> = {
  ...
  fr: {
    ...
    todaySectionHealthDesc: 'Conseil du coach et détail par pilier',
    ...
    todayWeeklyChallengesDesc: 'Objectifs entraînement + nutrition + volume. Noyau gratuit.',
    ...
    todaySectionProgressDesc: 'Préparation, stats et historique',
    ...
    todayMuscleReadinessDesc: "D'après votre historique récent. Groupes prêts à cibler.",
    todayNoRecentData: 'Pas de données récentes',
    todayDaysRest: '{{days}}j de repos',
    todayTrainGroup: 'Entraîner {{group}} →',
    todayRecommendedStart: 'Point de départ recommandé',
    todayRecommendedStartDesc: 'Selon votre profil (modifier dans Profil).',
    todayFocusLabel: 'Focus :',
    todayWithBodyweight: 'au poids du corps / minimal',
    todayWithEquipment: 'avec le matériel disponible',
    ...
    todayYourWins: 'Vos victoires et séries',
    todayViewLeaderboard: 'Voir le classement →',
    todayInstallPwa: 'Installez Mission Winning pour un usage hors ligne (PWA).',
    todayInstallNow: 'Installer maintenant',
    todayPwaInstallHint: "Utilisez le menu du navigateur (⋮ > Ajouter à l'écran d'accueil / Installer).",
    todayBodyweightTag: 'poids du corps',
    fuelTitle: 'Nutrition',
    fuelSignInDesc: "Synchronisez repas et macros entre appareils.",
    todayCustomizeTitle: "Personnaliser Aujourd'hui",
    todayCustomizeDesc: 'Choisissez les sections à afficher. Enregistré sur cet appareil.',
    challengeTrain7Title: 'Série de 7 jours',
    challengeTrain7Desc: 'Enregistrez un entraînement sur 7 jours distincts cette semaine.',
    challengeProtein5Title: '5 jours haute protéine',
    challengeProtein5Desc: '120 g+ de protéines sur 5 jours (pilier Fuel).',
    challengeVolume10kTitle: '10K volume hebdo',
    challengeVolume10kDesc: 'Accumulez 10 000 de volume cette semaine.',
    photoLogProcessing: "Estimation sur l'appareil…",
    photoLogEstimateTitle: 'Repas estimé',
    photoLogEstimateLow: 'Faible confiance — modifiez ensuite si besoin.',
    photoLogLogEstimate: "Enregistrer l'estimation",
    photoLogRetake: 'Choisir une autre photo',
    todayWin7DayStreak: 'Série de 7 jours ({{current}}/7)',
    todayWinVolume: '1000+ volume total ({{current}}/1000 {{unit}})',
    todayWinSessions: '15+ séances ({{current}}/15)',
    todayWinSavedRoutines: '3+ routines enregistrées ({{current}}/3)',
    todayWinProteinDays: 'Jours haute protéine 150 g+ ({{current}}/5+)',
    todayWinUnderStars: 'Sous les étoiles ({{current}}/3 séances de nuit)',
    todayWinDawn: "À l'aube ({{current}}/3 séances matinales)",
    todayWinBadgeFoot:
      'Enregistrez des victoires chaque jour — séries et volume alimentent votre Score de mission.',
    todayRankings: 'Classement',
    todayAssessmentCardTitle: 'Dernière évaluation et victoires récentes',
    todayAssessmentLast: 'Dernière : risque {{risk}} ({{date}})',
    todayAssessmentRetake: 'Refaire',
    todayAssessmentNone: 'Pas encore d’évaluation.',
    todayAssessmentTake: 'Faire l’évaluation de préparation gratuite →',
    todayRecentPillarWinsLabel: 'Victoires récentes par pilier :',
    todaySeeNutritionLink: 'Tout voir dans Nutrition →',
    todayPillarWinEmpty: 'Enregistrez des victoires dans Move ou Mind (cloud à la connexion).',
    ...
    todayReadinessGood: 'Prêt à s’entraîner',
    todayRecommendedFocusLine: 'Focus {{group}} — {{status}}',
    todayBodyRestUp: 'Reposez-vous',
    todayBodyTrainSmart: 'Entraînez-vous intelligemment',
    ...
    todayMetricsDemoNote: 'Aperçu — vos scores se mettent à jour quand vous vous entraînez',
    todayMissionScore: 'Score de mission',
    todayTrainingStreak: 'Série de {{count}} jours',
    todayMissionScoreTitle: 'Score de mission multi-piliers',
    ...
    coachInsightHighStrain:
      'Charge élevée avec peu de récupération. Un jour mobilité ou repos vous aidera à revenir plus fort.',
    coachInsightPrimed: 'Vous êtes prêt à vous entraîner. {{focusLine}}.',
    coachInsightSolidRecovery:
      'Bonne récupération — bon jour pour monter le volume sur vos groupes cibles ou une séance de référence.',
    coachInsightLowReadiness:
      'Préparation basse. Enregistrez des protéines dans Fuel, essayez Mind, ou restez léger aujourd’hui.',
    coachInsightSteady: 'Progrès régulier. {{focusLine}} quand vous êtes prêt.',
    coachInsightNeedMove:
    ...
    coachInsightSynergyMove:
      'Bonne semaine d’entraînement — couplez-la avec de la mobilité pour continuer à progresser.',
    coachInsightNeedTrack:
      'Vous vous entraînez régulièrement — enregistrez une marche ou une course dans Track.',
    coachInsightNeedLearn:
    ...
    coachActionOpenMove: 'Ouvrir le pilier Move',
    coachActionOpenMind: 'Ouvrir le pilier Mind',
    coachActionOpenTrack: 'Ouvrir le pilier Track',
    coachActionOpenLearn: 'Ouvrir les cours Learn',
    coachActionOpenFuel: 'Ouvrir Fuel Coach',
    todayEditToday: "Modifier Aujourd'hui",
    coachActionStartWorkout: "Commencer l'entraînement",
    coachActionGoBuilder: 'Aller au Builder',
    coachActionLogNutrition: 'Enregistrer la nutrition',
    coachActionViewToday: "Voir le hub Aujourd'hui",
    ...
    coachPlanGenerating: 'Création de votre semaine…',
    coachPlanLoad: 'Charger',
    coachPlanRegenerate: 'Régénérer',
  },
  pt: {
    ...en,
    todayBasicEncouragement:
