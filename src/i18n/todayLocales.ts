...
const LOCALES: Partial<Record<string, TodayStrings>> = {
  ...
  de: {
    ...
    todaySectionHealthDesc: 'Coach-Tipp und Detail pro Säule',
    todaySectionWeek: 'Diese Woche',
    todaySectionWeekDesc: 'Challenges und Training des Tages',
    todayWeeklyChallenges: 'Wöchentliche Challenges',
    todayWeeklyChallengesDesc: 'Ziele Training + Ernährung + Volumen. Kostenloser Kern.',
    todayWeeklyChallengesDescOpenBeta: en.todayWeeklyChallengesDescOpenBeta,
    todayDayStreak: '{{count}}-Tage-Serie',
    todayStartWorkout: 'Heutiges Training starten',
    todaySectionProgress: 'Fortschritt und Tools',
    todaySectionProgressDesc: 'Bereitschaft, Stats und Verlauf',
    todayQuickOptions: 'Schnelloptionen',
    todayQuickOptionsDesc: 'Kostenlose Programme und gespeicherte Routinen.',
    todayBuildCustom: 'Individuelle Einheit erstellen →',
    todayMuscleReadiness: 'Muskelbereitschaft',
    todayMuscleReadinessDesc: 'Basierend auf deinem aktuellen Verlauf. Gruppen, die bereit sind.',
    todayNoRecentData: 'Keine aktuellen Daten',
    todayDaysRest: '{{days}}T Pause',
    todayTrainGroup: '{{group}} trainieren →',
    todayRecommendedStart: 'Empfohlener Startpunkt',
    todayRecommendedStartDesc: 'Laut deinem Profil (im Profil änderbar).',
    todayFocusLabel: 'Fokus:',
    ...
    todayStatDays: 'Tage',
    todayRecentWins: 'Aktuelle Siege',
    todayViewHistory: 'Gesamten Verlauf ansehen →',
    todayYourWins: 'Deine Siege und Serien',
    todayViewLeaderboard: 'Rangliste ansehen →',
    todayInstallPwa: 'Installiere Mission Winning für Offline-Nutzung (PWA).',
    todayInstallNow: 'Jetzt installieren',
    todayPwaInstallHint: 'Nutze das Browser-Menü (⋮ > Zum Startbildschirm / Installieren).',
    todayBodyweightTag: 'Körpergewicht',
    fuelTitle: 'Ernährung',
    fuelSignInDesc: 'Synchronisiere Mahlzeiten und Makros zwischen Geräten.',
    todayCustomizeTitle: 'Heute anpassen',
    todayCustomizeDesc: 'Wähle die Abschnitte, die angezeigt werden. Gespeichert auf diesem Gerät.',
    challengeTrain7Title: '7-Tage-Serie',
    challengeTrain7Desc: 'Protokolliere an 7 verschiedenen Tagen dieser Woche ein Training.',
    challengeProtein5Title: '5 Tage hohes Protein',
    challengeProtein5Desc: '120 g+ Protein an 5 Tagen (Fuel-Säule).',
    challengeVolume10kTitle: '10K Wochenvolumen',
    challengeVolume10kDesc: 'Sammle 10.000 Volumen in dieser Woche.',
    photoLogProcessing: 'Schätzung auf dem Gerät…',
    photoLogEstimateTitle: 'Geschätzte Mahlzeit',
    photoLogEstimateLow: 'Geringe Sicherheit — danach bei Bedarf anpassen.',
    photoLogLogEstimate: 'Schätzung speichern',
    ...
    todayWinSavedRoutines: '3+ gespeicherte Routinen ({{current}}/3)',
    todayWinProteinDays: 'Tage mit hohem Protein 150 g+ ({{current}}/5+)',
    todayWinUnderStars: 'Unter den Sternen ({{current}}/3 Nachteinheiten)',
    todayWinDawn: 'Bei Tagesanbruch ({{current}}/3 Morgeneinheiten)',
    todayWinBadgeFoot:
      'Protokolliere jeden Tag Siege — Serien und Volumen speisen deinen Mission Score.',
    todayRankings: 'Rangliste',
    todayAssessmentCardTitle: 'Letzte Bewertung und aktuelle Siege',
    todayAssessmentLast: 'Zuletzt: Risiko {{risk}} ({{date}})',
    todayAssessmentRetake: 'Erneut machen',
    todayAssessmentNone: 'Noch keine Bewertung.',
    todayAssessmentTake: 'Kostenlose Bereitschaftsbewertung machen →',
    todayRecentPillarWinsLabel: 'Aktuelle Siege nach Säule:',
    todaySeeNutritionLink: 'Alles in Ernährung ansehen →',
    todayPillarWinEmpty: 'Protokolliere Siege in Move oder Mind (Cloud bei Anmeldung).',
    ...
    todayMuscleCore: 'Core',
    todayReadinessPrime: 'Bereit fortzuschreiten',
    todayReadinessRecovering: 'In der Erholung',
    todayReadinessGood: 'Bereit zu trainieren',
    todayRecommendedFocusLine: 'Fokus {{group}} — {{status}}',
    todayBodyRestUp: 'Erhole dich',
    todayBodyTrainSmart: 'Trainiere smart',
    todayBodyPrimePush: 'Bereit zu pushen',
    todayBodyLightWeek: 'Leichte Woche',
    todayBodyModerateLoad: 'Moderate Belastung',
    todayBodyHighLoad: 'Hohe Belastung',
    todayBodyNeedsRest: 'Braucht Pause',
    ...
    todayMetricsDemoNote: 'Vorschau — deine Scores aktualisieren sich, wenn du trainierst',
    todayMissionScore: 'Mission Score',
    todayTrainingStreak: '{{count}}-Tage-Serie',
    todayMissionScoreTitle: 'Multi-Säulen Mission Score',
    ...
    coachInsightHighStrain:
      'Hohe Belastung bei wenig Erholung. Ein Mobilitäts- oder Ruhetag hilft dir, stärker zurückzukommen.',
    coachInsightPrimed: 'Du bist bereit zu trainieren. {{focusLine}}.',
    coachInsightSolidRecovery:
      'Gute Erholung — guter Tag, um Volumen auf Zielgruppen oder eine Referenz-Einheit zu steigern.',
    coachInsightLowReadiness:
      'Niedrige Bereitschaft. Protokolliere Protein in Fuel, probiere Mind, oder bleib heute leicht.',
    ...
    coachInsightSynergyMove:
      'Gute Trainingswoche — kombiniere sie mit Mobilität, um weiter fortzuschreiten.',
    coachInsightNeedTrack:
      'Du trainierst regelmäßig — protokolliere einen Spaziergang oder Lauf in Track.',
    coachInsightNeedLearn:
    ...
    coachActionOpenTrack: 'Track-Säule öffnen',
    coachActionOpenLearn: 'Learn-Kurse öffnen',
    coachActionOpenFuel: 'Fuel Coach öffnen',
    todayEditToday: 'Heute bearbeiten',
    coachActionStartWorkout: 'Training starten',
    coachActionGoBuilder: 'Zum Builder',
    coachActionLogNutrition: 'Ernährung protokollieren',
    coachActionViewToday: 'Heute-Hub ansehen',
    todayPillarScoreByPillar: 'Score nach Säule',
    todayPillarTrain: 'Trainieren',
    todayPillarFuel: 'Ernährung',
    todayPillarMove: 'Bewegen',
    ...
    coachPlanGenerating: 'Deine Woche wird erstellt…',
    coachPlanLoad: 'Laden',
    coachPlanRegenerate: 'Neu generieren',
  },
  it: {
    ...en,
    todayBasicEncouragement:
