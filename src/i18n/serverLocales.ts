...
const SERVER_EN: Record<string, string> = {
  navServer: 'Messenger',
  moreServerDesc: 'Rooms on this device',
  serverEyebrow: 'Mission Server',
  serverTitle: 'Garage',
  serverSubtitle: 'Rooms on this device. Not a feed.',
  ...
  serverLocalNote: 'Saved on this device. Cloud fan-out only if Realtime is on and you are signed in.',
