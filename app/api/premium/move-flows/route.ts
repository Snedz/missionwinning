...
import { PREMIUM_MOVE_FLOWS } from '@/data/premiumMoveFlows';
...
/** Premium Move mobility flows — server-gated, Super Bundle. */
export async function GET(request: NextRequest) {
  if (isDemoPremiumEnabled()) {
    return NextResponse.json({ flows: PREMIUM_MOVE_FLOWS });
  }
