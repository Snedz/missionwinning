...
import { PREMIUM_TRACK_PROGRAMS } from '@/data/premiumTrackPrograms';
...
/** Premium Track activity programs — server-gated, Super Bundle. */
export async function GET(request: NextRequest) {
  if (isDemoPremiumEnabled()) {
    return NextResponse.json({ programs: PREMIUM_TRACK_PROGRAMS });
  }
