...
import { PREMIUM_LEARN_PATHS } from '@/data/premiumLearnPaths';
...
/** Premium Learn specialist paths — server-gated, never bundled for free users. */
export async function GET(request: NextRequest) {
  if (isDemoPremiumEnabled()) {
    return NextResponse.json({ paths: PREMIUM_LEARN_PATHS });
  }
