...
| **Pregnancy / miscarriage / postpartum safety** | [docs/PREGNANCY_SAFETY.md](docs/PREGNANCY_SAFETY.md), [help/pregnancy-safety.md](docs/help/pregnancy-safety.md) | Inferring the flag; gating the logger; “safe pregnancy PT”; claiming we prevent loss |
