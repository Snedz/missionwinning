...
| **Super Bundle content depth** | [docs/SUPER_BUNDLE_CONTENT_PLAN.md](docs/SUPER_BUNDLE_CONTENT_PLAN.md) — parent catalog plan (`.700`). **Leftover overnight:** [docs/SUPER_BUNDLE_SHOP_HONESTY_PLAN.md](docs/SUPER_BUNDLE_SHOP_HONESTY_PLAN.md) — shop/FAQ/Coach merch (`.705`); Move catalog is #497 | Adding catalog volume; food database as the SKU; new tabs; trial; colliding with #497 Move flows |
