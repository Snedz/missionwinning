...
| **Product IA (locked rooms)** | [docs/IA_SKELETON.md](docs/IA_SKELETON.md) — CoS freeze: LOG / WEEK / GARAGE; named rooms Today · Train · Coach (AI) · History · Library | Costume / Studio / Message tab / Explore-as-shop; promoting `/server` to a tab |
