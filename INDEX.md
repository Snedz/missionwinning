...
| Social / launch posts | [docs/SOCIAL_LAUNCH.md](docs/SOCIAL_LAUNCH.md) · [docs/BETA_INVITE.md](docs/BETA_INVITE.md) leftover | Treating ≥10 invites as the launch |
...
| LLC + Stripe | [docs/LLC_AND_PAYMENTS.md](docs/LLC_AND_PAYMENTS.md) (incl. §1d mute-pay after EIN), [docs/STRIPE_PREMIUM_SETUP.md](docs/STRIPE_PREMIUM_SETUP.md), [docs/PRELAUNCH_CAPITAL.md](docs/PRELAUNCH_CAPITAL.md) | Committing EIN digits or a postal street; paid ads before week-4 |
...
| **Free-first mute-pay (pricing later)** | [docs/FREE_BETA.md](docs/FREE_BETA.md) + [docs/LLC_AND_PAYMENTS.md](docs/LLC_AND_PAYMENTS.md) §1d | Showing Bundle/checkout while FREE_BETA on; committing EIN digits or a postal street |
...
| Beta testers | [docs/BETA_INVITE.md](docs/BETA_INVITE.md) leftover kit — **no invite cohort** | Treating ≥10 invites as a flip gate |
