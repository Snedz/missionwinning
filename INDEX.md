...
| **Why this / transparency report** | [docs/TRANSPARENCY_PLAN.md](docs/TRANSPARENCY_PLAN.md) · code `src/lib/transparency/` · `/account/transparency` | X Settings clone; impressions / For You; claiming we suppress posts; standing on the log path |
