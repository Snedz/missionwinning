...
| **BANGERS sell-first bet (not the MW wedge)** | [RESEARCH/BANGERS/INDEX.md](RESEARCH/BANGERS/INDEX.md) — track 02 [clearshot-ios](RESEARCH/BANGERS/clearshot-ios/INDEX.md) | Starting `apps/ios`; implementing `utility.clearshot` UI; treating a paper pack as a ship; inventing paid intents; replacing `PAYMENT_URL` with a guessed checkout |
