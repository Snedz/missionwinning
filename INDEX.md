...
| **Product imagery / form diagrams / Learn art** | [docs/MEDIA_SYSTEM.md](docs/MEDIA_SYSTEM.md), [`media/manifest.json`](media/manifest.json), `public/form-guides/`, `public/learn/`, `public/art/` | Runtime image-gen APIs; photoreal form photos as Train default |
