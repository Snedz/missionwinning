...
| **Super Bundle content depth** | [docs/SUPER_BUNDLE_CONTENT_PLAN.md](docs/SUPER_BUNDLE_CONTENT_PLAN.md) — parent catalog plan (`.700`). **Leftover overnight:** [docs/SUPER_BUNDLE_SHOP_HONESTY_PLAN.md](docs/SUPER_BUNDLE_SHOP_HONESTY_PLAN.md) — Move table counts + Train why + vs-stack help (`.707`). Do not collide with #498 shop, #497 Move, #499 Fuel, #501 Mind, #502 Learn | Adding catalog volume; editing `BundlePage` layout; trial; stealing specialist shop strings |
