...
| **Unpublished cash-fuel SKUs** (resume-kit / invoice-lite) | [fuel/INDEX.md](fuel/INDEX.md) · laws [fuel/LAWS.md](fuel/LAWS.md) | Nutrition Fuel (`/nutrition`); inventing a checkout URL; treating a price label as a live charge |
