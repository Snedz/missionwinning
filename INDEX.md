...
| **Product IA (locked rooms)** | [docs/IA_SKELETON.md](docs/IA_SKELETON.md) — three loops, existing room map, refuse list | Costume / sidebar / Studio; minting empty rooms; promoting `/server` to a tab |
