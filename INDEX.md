...
| **BANGERS side ideas** (receipt OCR · dual-cam tutor · IPTC auditor · Center Stage · unlock vault · agent job bus · screenshot pages) | [RESEARCH/BANGERS/README.md](RESEARCH/BANGERS/README.md) · overnight [RESEARCH/BANGERS/OVERNIGHT_GLM53.md](RESEARCH/BANGERS/OVERNIGHT_GLM53.md) | Inventing a checkout URL; treating a `priceLabel` as a live charge; building Spatial Reframe (API locked); Screen Time bypass; writing 05 before 01 dual-capture-plus |
