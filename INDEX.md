...
| **Product imagery / form diagrams / Learn art** | [docs/MEDIA.md](docs/MEDIA.md) (who appears · representation ≠ territory), [docs/MEDIA_SYSTEM.md](docs/MEDIA_SYSTEM.md) (pipeline), [docs/MEDIA_CAST_PLAN.md](docs/MEDIA_CAST_PLAN.md) (`.736` freeze), [media/FLOW_PROMPTS.md](media/FLOW_PROMPTS.md), [`media/manifest.json`](media/manifest.json), `public/form-guides/`, `public/learn/`, `public/art/` · hosted markets: [`src/lib/legal/supportedRegions.ts`](src/lib/legal/supportedRegions.ts) | Runtime image-gen APIs; photoreal form photos as Train default; DEI campaign page; Cantonese/HK as a separate look; copy/alt/filenames that imply blocked-country operations |
...
| **Pregnancy / miscarriage / postpartum safety** | [docs/PREGNANCY_SAFETY.md](docs/PREGNANCY_SAFETY.md), [help/pregnancy-safety.md](docs/help/pregnancy-safety.md) | Inferring the flag; gating the logger; changing Coach prescriptions or hiding CTAs; “safe pregnancy PT”; claiming we prevent loss |
