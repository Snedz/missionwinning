...
> and `.698` dropped `.636` detail (full text remains in LOG.md / archive)
...
- **`.698`:** (`2026.07-unified.698`) **Guidebook Ch3 + Periodization intro** — Programming & Tuning tutorial: log offline, Coach weeks from logs (no wearable); `pd-0` on periodization-design. Distinct from #479 `sb-0` and `.680` Ch4. Learn ungated.
