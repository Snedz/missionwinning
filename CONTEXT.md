...
## Now (2026-08-13 · web `2026.07-unified.727` · Android `1.24.1`)
...
> and `.727` dropped `.636` detail (full text remains in LOG.md / archive)
...
- **`.727`:** (`2026.07-unified.727`) **PT safety hard-session warning** — pre-start sheet before PFT / 2-mile / max / test (and field test when present); Back does not start; never gates a normal set. Not medical care; call local emergency services. Help: `docs/help/pt-safety.md`.
