...
## Now (2026-08-05 · web `2026.07-unified.520` · Android `1.24.1`)
...
> and `.505`–`.520` dropped detail (full text remains in LOG.md / archive)
...
- **`.520`–`.515`:** rewards INDEX · volume helper · re-entry · EN ranks · perfect_week. volume helper · re-entry shame-free · EN ranks · perfect_week paths. re-entry shame-free pin · EN ranks/badges · perfect_week paths. EN ranks/badges + challenge XP catalog + perfect_week fuel/pillar paths. challenge XP catalog SoT + perfect_week fuel/pillar paths.
