...
## Now (2026-08-05 · web `2026.07-unified.517` · Android `1.24.1`)
...
> and `.505`–`.517` dropped detail (full text remains in LOG.md / archive)
...
- **`.517`–`.515`:** EN ranks/badges + challenge XP catalog + perfect_week fuel/pillar paths. challenge XP catalog SoT + perfect_week fuel/pillar paths.
