...
- **`.746`:** (`2026.07-unified.746`) **Pregnancy + miscarriage safety v1 (counsel-hold)** — optional athlete-owned flag; **only** the hard-session stop-symptoms line changes. Not prenatal care. Draft until counsel reviews copy.
