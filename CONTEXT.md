...
- **`.1070`:** (`2026.07-unified.1070`) **Coverage floor 438 → 493 + beachhead i18n** — Floor raised to measured 493 after #935. es/pt core namespaces back under 40% placeholders (today/nav/activeWorkout/learn). `Alpha` allowlisted as stage. No invented unit tests. No TodayDesk. Paper only. `[skip vercel]`. No tip-promote. Live www stays `.697`. PRIVATE_MODE stays.
