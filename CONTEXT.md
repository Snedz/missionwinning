...
## Now (2026-08-10 · web `2026.07-unified.647` · Android `1.24.1`)
...
- **`.647`:** (`2026.07-unified.647`) **Coach voice floors** — rules plan-voice keys use coachVoiceLine English floors (never `coachVoiceDeload` raw on hydrate).
