...
## Now (2026-08-05 · web `2026.07-unified.504` · Android `1.24.1`)
...
- **`.504`:** Form Index re-assemble — OHP + pull-ups stills PASS, re-wired SIDE_IDS.
- **`.503`:** Kaizen K11 — History list Again + day-replay train retrain.
- **`.502`–`.500`:** Kaizen K6/K7, Coach density, Today language, Active empty.
