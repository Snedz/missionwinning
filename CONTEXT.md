...
- **`.703`:** (`2026.07-unified.703`) **E-Adjacency set-row target + cite** — Target stacked above PREVIOUS, cited from last-session logs (e.g. from last Tue · sets 2–4). Free. Not HUD / Recovery %.
