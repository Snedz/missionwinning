...
## Now (2026-08-10 · web `2026.07-unified.652` · Android `1.24.1`)
...
- **`.652`:** (`2026.07-unified.652`) **About free-beta mute** — company page mission + business copy never pitch Super Bundle in open beta.
- **`.651`:** (`2026.07-unified.651`) **Score foot free-beta mute** — pillar score foot never paints Super Bundle in open beta.
- **`.650`:** (`2026.07-unified.650`) **Badge count i18n** — Today rewards passes `n` for `{{n}} badges earned`.
- **`.649`:** (`2026.07-unified.649`) **Assessments stage honesty** — Stage of Change chips use real locale keys + English floors.
