...
> and `.705` dropped `.255` detail (full text remains in LOG.md / archive)
...
- **`.705`:** (`2026.07-unified.705`) **Learn original Super Bundle sequence** — premium Ch11–12 Diataxis (Train→Coach→Fuel/Move/Mind); free intro stays free. Plan: [docs/LEARN_SUPER_BUNDLE_PLAN.md](docs/LEARN_SUPER_BUNDLE_PLAN.md).
