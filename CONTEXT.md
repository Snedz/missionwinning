...
## Now (2026-08-05 · web `2026.07-unified.493` · Android `1.24.1`)
...
- **`.493`:** Public docs anti-slop — Vision/Feedback/Paths rewrite from vision.md.
- **`.492`:** Landing At-a-glance bottom 2px rule (flush grid covered section-seam).
- **`.491`:** Next nested postcss floor (8.5.18+) + all-lang pack/public parity.
- **`.490`:** Unicode pack placeholder guard (hi/vi/th → English keys).
- **`.489`:** next@16.3.0; public/locales pack parity; formPatterns pack media.
- **`.488`–`.474`:** i18n call-site, free-beta mute, rest outdoor, form residual.
