...
## Now (2026-08-13 · web `2026.07-unified.729` · Android `1.24.1`)
...
> and `.729` dropped `.636` detail (full text remains in LOG.md / archive)
...
- **`.729`:** (`2026.07-unified.729`) **Visibility + Under the Hood** — Account `/account/transparency` names limits + reasons; `/account/under-the-hood` publishes live/Club boosts and visibility-only penalties; download JSON + text includes weights + athlete labels. Occupied `.698`–`.728`.
