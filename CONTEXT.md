...
> and `.704` dropped `.636` detail (full text remains in LOG.md / archive)
...
- **`.704`:** (`2026.07-unified.704`) **Missed-day shame-free re-entry (S7)** — two+ local calendar days off, Today Start field quiet line “Two days off. Here’s the 20-minute version.” (0.1 beta). Primary Start uses the short dose. No streak guilt, no new reminders.
