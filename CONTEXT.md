...
- **`.928`:** (`2026.07-unified.928`) **Public Alpha snapshot exporter** — `npm run snapshot:public` writes a sibling orphan copy for `Mission-Winning/missionwinning`. Origin stays Snedz. No Public flip. No `PRIVATE_MODE` flip.
