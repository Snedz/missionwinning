...
## Now (2026-08-10 · web `2026.07-unified.668` · Android `1.24.1`)
...
- **`.667`:** (`2026.07-unified.667`) **Compare stories free-beta mute** — superseded by `.668` removal (historical).
- **`.666`:** (`2026.07-unified.666`) **Calculators macro foot free-beta mute** — macro tool never pitches Premium programs under open beta.
