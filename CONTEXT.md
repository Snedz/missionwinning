...
## Now (2026-08-10 · web `2026.07-unified.651` · Android `1.24.1`)
...
- **`.651`:** (`2026.07-unified.651`) **Score foot free-beta mute** — pillar score foot never paints Super Bundle in open beta (pack override fixed).
