...
- **`.704`:** (`2026.07-unified.704`) **Missed-day shame-free re-entry (S7)** — two+ local calendar days off, Today (`/log`) quiet line “Two days off. Here’s the 20-minute version.” Primary Start uses the short dose. No streak guilt, no new reminders.
