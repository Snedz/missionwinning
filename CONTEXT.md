...
## Now (2026-08-15 · web `2026.07-unified.825` · Android `1.24.1`)
...
- **`.825`:** (`2026.07-unified.825`) **Guard drift** — planned rest out of rewards; first-paint copy twins; `/help` mapped. No `PRIVATE_MODE` flip.
