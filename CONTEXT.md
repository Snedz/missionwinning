...
## Now (2026-08-13 · web `2026.07-unified.708` · Android `1.24.1`)
...
> and `.708` dropped `.636` detail (full text remains in LOG.md / archive)
...
- **`.708`:** (`2026.07-unified.708`) **Five-event field test** — free Train logger session + optional published-table points; garage SDC unscored; vs-last vs last field test only. Founder override (not America marketing).
