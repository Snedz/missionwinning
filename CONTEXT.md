...
## Now (2026-08-05 · web `2026.07-unified.529` · Android `1.24.1`)
...
> and `.505`–`.529` dropped detail (full text remains in LOG.md / archive)
...
- **`.529`–`.515`:** Today header date · analytics/trends · nutrition merge · formatLocal* cascade · perfect_week.
