...
## Now (2026-08-04 · web `2026.07-unified.337` · Android `1.24.1`)
...
- **`.324`:** Leaderboard empty/error i18n; uncovered **121→112**.
- **`.323`:** Coaching interest form i18n; uncovered **134→121**.
