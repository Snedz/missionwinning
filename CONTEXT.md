...
## Now (2026-08-12 · web `2026.07-unified.672` · Android `1.24.1`)
...
- **`.672`:** (`2026.07-unified.672`) **Exercise count single source** — landing/SEO derive from `CONTENT_FLOORS.exercisePages` (228); `/exercises` awaits full catalog (229 unique) — no 217/126 drift; `landingExerciseCount.test.ts` guard.
