...
- **`.700`:** (`2026.07-unified.700`) **F-017 account-lite** — I-Day has no sign-in wall; first set logs with no account; quiet Keep this diary? after first workout (never mid-set; Train never offers; gate says Free beta / Enter with code / Get notified; PRIVATE_MODE unchanged).
