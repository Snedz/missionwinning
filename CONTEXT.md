...
- **`.642`:** (`2026.07-unified.642`) **Coach why floors** — adapt banner "Why today's plan" never blanks on hydrate; English floors for every engine whyKey.
- **`.641`:** (`2026.07-unified.641`) **Victory next single source** — mw-core owns pickVictoryNextAction (week-1 session 2 first); web re-exports.
