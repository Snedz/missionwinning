...
## Now (2026-08-04 · web `2026.07-unified.427` · Android `1.24.1`)
...
- **`.420`:** NL `1/2 cup` fraction qty — denominator trap fixed; confidence stays medium.
- **`.419`:** Pure `buildTodayCandidates` — densest evening session+week locked; nodes stay in shell.
- **`.418`:** ActiveExerciseCard next-target helpers + More/SetOptions menu extract (536→380).
