...
## Now (2026-08-05 · web `2026.07-unified.494` · Android `1.24.1`)
...
- **`.494`:** Flow architecture doc + Product footer Start free / How Coach adapts.
...
- **`.489`–`.474`:** next upgrade, i18n, free-beta mute, outdoor form residual.
