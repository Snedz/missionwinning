...
## Now (2026-08-14 · web `2026.07-unified.811` · Android `1.24.1`)
...
- **`.811`:** (`2026.07-unified.811`) **Visibility access Alpha** — access details say mute-pay, not Open-beta. No `PRIVATE_MODE` flip.
