...
## Now (2026-08-10 · web `2026.07-unified.646` · Android `1.24.1`)
...
- **`.646`:** (`2026.07-unified.646`) **Muscle readiness + journal floors** — Progress status uses readinessStatusDefault (not raw statusKey); journal pillar labels never paint `train`.
...
- **`.644`:** (`2026.07-unified.644`) **Today health chips + pillar labels** — CrossPillarCoachChips insight/action floors; PillarScoreBreakdown never raw keys.
