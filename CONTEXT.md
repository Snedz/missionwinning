...
- **`.1070`:** (`2026.07-unified.1070`) **Coverage floor 438 → 493 + i18n HOLD** — Floor raised to measured 493 after #935. es/pt core namespaces under 40%. Catalog `justGoTitle` / `justGoDesc` / `justGoEyebrow` / `victoryNextEnvCite`. `Alpha` allowlisted. No invented unit tests. No TodayDesk craft. Paper only. `[skip vercel]`. No tip-promote. Live www stays `.697`. PRIVATE_MODE stays.
