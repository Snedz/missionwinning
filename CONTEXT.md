...
- **`.953`:** (`2026.07-unified.953`) **MW export re-imports** — Account card downloads native MW CSV. Same preview + confirm door. Re-import of that file is a no-op. Existing native sessions win. Guest. Strong / Hevy paths unchanged. No `PRIVATE_MODE` flip.
