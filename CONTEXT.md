...
## Now (2026-08-13 · web `2026.07-unified.699` · Android `1.24.1`)
...
> and `.699` dropped `.636` detail (full text remains in LOG.md / archive)
...
- **`.699`:** (`2026.07-unified.699`) **Super Bundle Move premium flows** — 48→56 clock-honest original timed protocols; S6 free ids frozen; no Victory seam (#491).
