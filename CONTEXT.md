...
## Now (2026-08-04 · web `2026.07-unified.446` · Android `1.24.1`)
...
- **`.439`:** ActiveExerciseList peel — exercise map off ActiveWorkoutPage (~727→686).
- **`.438`:** NL `¼` + `three-quarters` hyphen + `couple` → 2.
- **`.437`:** CoachFreeFormAskPanel + SoftBundleChatTip peel — chat panel 492→399.
- **`.436`:** NL unicode ½/¾/1½ + half-of / three-quarters / two-thirds.
