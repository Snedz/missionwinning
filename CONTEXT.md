...
- **`.954`:** (`2026.07-unified.954`) **Today return path** — one Start; last + next sit on it. Empty last/next invent nothing. Coach stays in Show all. First set still ungated. No `PRIVATE_MODE` flip.
