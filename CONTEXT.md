...
## Now (2026-08-12 · web `2026.07-unified.674` · Android `1.24.1`)
...
- **`.674`:** (`2026.07-unified.674`) **Press kit path leak** — `/press` no longer cites `docs/brand-guidelines.md`; usage summarized on page.
