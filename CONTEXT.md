...
## Now (2026-08-05 · web `2026.07-unified.531` · Android `1.24.1`)
...
> and `.505`–`.531` dropped detail (full text remains in LOG.md / archive)
...
- **`.531`–`.515`:** Today rewards a11y/challenges · journal when · fuel clock · formatLocal* cascade · perfect_week.
