...
## Now (2026-08-05 · web `2026.07-unified.503` · Android `1.24.1`)
...
- **Framework review (docs):** stay on Next 16 PWA + selective decompose — [docs/FRAMEWORK_REVIEW.md](docs/FRAMEWORK_REVIEW.md) (Train fat cluster, nutrition outbox gap, ranked backlog; no rewrite).
