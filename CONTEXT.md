...
## Now (2026-08-05 · web `2026.07-unified.526` · Android `1.24.1`)
...
> and `.505`–`.526` dropped detail (full text remains in LOG.md / archive)
...
- **`.526`–`.515`:** formatLocalMonthKey · trend labels · HistoryDay formatLocalDateKey · WhatsNew · perfect_week.
