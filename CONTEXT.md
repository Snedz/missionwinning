...
- **`.700`:** (`2026.07-unified.700`) **Super Bundle Fuel premium recipes** — +30 protein-first garage/travel plates (110→140); floors + teasers honest; Fuel Coach/shop copy protein-first, not a food database.
