...
- **`.698`:** (`2026.07-unified.698`) **Gated www honesty (F-008)** — Free beta / access-code framing on `/private` + Welcome (no invite-only product status); Train→Coach teaser; `/`+`/log` stay gate redirects.
