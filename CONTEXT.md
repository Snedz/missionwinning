...
- **`.464`:** Form Index pilot — 8 clinical side posters under `/form/{id}/side.webp`; pack beats SVG.
- **`.463`:** Sprint A Imagine stills — invite kettlebell square, coach 9:16 arcs, Scout re-inked.
