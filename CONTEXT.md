...
## Now (2026-07-25 · web `2026.07-unified.138` · Android `1.24.1`)
...
- **Founder:** Accept B on Android + phone excellence → invites → YC F26. **Wire the Deploy Hook webhook** ([checklist §1.1](docs/VERCEL_DEPLOY_CHECKLIST.md)) then promote `.138`; clear Actions billing to restore the PR gate. Before Public: `npm run secrets:scan`, enable GitHub secret scanning + push protection.
