...
- **`.929`:** (`2026.07-unified.929`) **Guards match the product** — LearnVs `otherLearnVsPages` takes a string; Journal empty greps the shipped debrief; Talk has no mic; harness `ready-for-founder` is not SMOOTHER. No `PRIVATE_MODE` flip.
