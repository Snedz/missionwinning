...
## Now (2026-08-12 · web `2026.07-unified.677` · Android `1.24.1`)
...
> and `.677` dropped `.668` detail (full text remains in LOG.md / archive)
...
- **`.677`:** (`2026.07-unified.677`) **PWA start_url gate-public** — cold install opens `/private` not gated `/log`; `id` unchanged.
