...
## Now (2026-08-05 · web `2026.07-unified.518` · Android `1.24.1`)
...
> and `.505`–`.518` dropped detail (full text remains in LOG.md / archive)
...
- **`.518`–`.515`:** re-entry shame-free pin · EN ranks/badges · perfect_week paths. EN ranks/badges + challenge XP catalog + perfect_week fuel/pillar paths. challenge XP catalog SoT + perfect_week fuel/pillar paths.
