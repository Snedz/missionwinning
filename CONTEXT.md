...
## Now (2026-08-13 · web `2026.07-unified.712` · Android `1.24.1`)
...
> and `.712` dropped `.636` detail (full text remains in LOG.md / archive)
...
- **`.712`:** (`2026.07-unified.712`) **Public version stamp `Mission Winning 0.1 (beta)`** — athlete chrome (gated www, About, version chips); `/api/health` `build` stays unified. Free beta, not invite-only / v1.0. Releases colliding `.700`; skips occupied `.698`–`.711`.
