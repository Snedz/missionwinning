...
## Now (2026-08-13 · web `2026.07-unified.736` · Android `1.24.1`)
...
> and `.736` dropped `.253` detail (full text remains in LOG.md / archive)
...
- **`.736`:** (`2026.07-unified.736`) **Multicultural form stills; representation ≠ territory** — `squats` / `push-ups` / `pull-ups` 4-still cast sets; `MEDIA.md` contract; country availability is `supportedRegions.ts` (no blocked-country launch copy). Still-only until loops recast.
