...
## Now (2026-08-14 · web `2026.07-unified.773` · Android `1.24.1`)
...
- **`.773`:** (`2026.07-unified.773`) **Coach chat local RAG + ReAct** — Premium chat retrieves catalog/guidebook in-process and may call local tools (cite last set, week, form, load band). ZDR one-shots only. No vendor Collections. No `PRIVATE_MODE` flip. `.771`/#550 and `.772`/#551 reserved.
