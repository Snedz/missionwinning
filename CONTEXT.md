...
- **`.700`:** (`2026.07-unified.700`) **F-017 account-lite** — I-Day has no sign-in wall; first set logs with no account; quiet Keep this diary? after first workout (never mid-set; PRIVATE_MODE unchanged).
