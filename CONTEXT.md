...
- **`.1070`:** (`2026.07-unified.1070`) **Coverage floor 438 → 493** — Ratchets Coverage floors red after #935 minis. Floor raised to the measured untested count. Capability-bus / minis stubs + existing UI Playwright-covered debt. No invented unit tests. Paper only. `[skip vercel]`. No tip-promote. Live www stays `.697`. PRIVATE_MODE stays.
