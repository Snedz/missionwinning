...
## Now (2026-08-13 · web `2026.07-unified.705` · Android `1.24.1`)
...
> and `.705` dropped `.669` detail (full text remains in LOG.md / archive)
...
- **`.705`:** (`2026.07-unified.705`) **Super Bundle shop restore** — `/bundle` merchandises Free logger vs one paid SKU ($59/yr founders); checkout muted (Get notified) while FREE_BETA; depth still unlocked; no trial, no à la carte, no live Stripe.
...
- **Free-first beta (~4 weeks):** LLC + EIN pending — **shop merchandises Super Bundle** (Free vs one SKU); **checkout muted**; **depth still unlocked**; More/rail **Pillars demoted until first workout** (F-004 / `.695`) ([docs/FREE_BETA.md](docs/FREE_BETA.md)).
