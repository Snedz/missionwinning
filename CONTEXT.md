...
## Now (2026-08-04 · web `2026.07-unified.350` · Android `1.24.1`)
...
- **`.350`:** Active `resolveActiveGoalId` extract + wiring guard.
- **`.349`:** Seeded axe on Track after logging an activity.
