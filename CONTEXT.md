...
> and `.504` dropped `.489` detail (full text remains in LOG.md / archive)
> and `.505` dropped `.490` detail (full text remains in LOG.md / archive)
> and `.506` dropped `.491` detail (full text remains in LOG.md / archive)
...
- **`.506`:** Mission Women focus — I-Day sex, female seeds, lens (not a second app).
- **`.505`:** Opt-in cycle coaching — local prefs, soft readiness bias, Profile + Today chip.
- **`.504`–`.500`:** Fair-by-sex principles, Kaizen retrain, Coach density, Today language.
