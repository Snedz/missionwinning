...
## Now (2026-08-13 · web `2026.07-unified.703` · Android `1.24.1`)
...
> and `.703` dropped `.636` detail (full text remains in LOG.md / archive)
...
- **`.703`:** (`2026.07-unified.703`) **E-Adjacency set-row target + cite** — Live-row Target above PREVIOUS, cited from last *live* session (e.g. From last Tue · sets 2–4); honest empty; tombstones skipped. Free. Not HUD / Recovery %.
