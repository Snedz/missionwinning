...
- **`.914`:** (`2026.07-unified.914`) **Today Show all holds Coach week** — date + pins + sentence + Start stay first paint. Open Show all for dose + adapt. Not the dashboard tour. No `PRIVATE_MODE` flip.
