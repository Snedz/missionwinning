...
## Now (2026-08-12 · web `2026.07-unified.679` · Android `1.24.1`)
...
- **`.679`:** (`2026.07-unified.679`) **Today focus honesty** — `{{focusLine}}` guard + coach-session focus via `resolveTodayFocus` on `/log`.
