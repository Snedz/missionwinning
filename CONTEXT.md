...
- **`.915`:** (`2026.07-unified.915`) **First Steps is a Show all row** — opens the checklist. Not a tour card. Not first paint. Dismiss does not hide this door. No `PRIVATE_MODE` flip.
