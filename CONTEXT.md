...
## Now (2026-08-05 · web `2026.07-unified.525` · Android `1.24.1`)
...
> and `.505`–`.525` dropped detail (full text remains in LOG.md / archive)
...
- **`.525`–`.515`:** trend labels · badge desc EN · HistoryDay formatLocalDateKey · WhatsNew · perfect_week.
