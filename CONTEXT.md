...
## Now (2026-08-12 · web `2026.07-unified.671` · Android `1.24.1`)
...
> and `.671` dropped `.626` detail (full text remains in LOG.md / archive)
...
- **`.671`:** (`2026.07-unified.671`) **Guidebook wedge CTAs** — Ch4 Getting Started + magazine `1.4.3` practice lines pitch Train log + Mission Coach from logs; originality logged; Learn heroes still parked.
...
- **`.668`:** (`2026.07-unified.668`) **Competitor compare removed** — `/compare` redirects to Start free; no Hevy/Strong/etc. comparison hub.
