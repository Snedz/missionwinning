...
## Now (2026-08-11 · web `2026.07-unified.670` · Android `1.24.1`)
...
- **`.670`:** (`2026.07-unified.670`) **Beta walkthrough UX honesty** — Today focusLine interpolation + coach-session focus; metric default units; BW volume reps; first-session XP; rules-based Coach labels; free-beta Account mute.
