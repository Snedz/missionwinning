...
- **`.955`:** (`2026.07-unified.955`) **Wednesday from their logs** — stable next day from the diary. Live plan owning the next day wins. Empty invents nothing. Coach cite, not a second Today Start. First set still ungated. No `PRIVATE_MODE` flip.
