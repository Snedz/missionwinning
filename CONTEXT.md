...
## Now (2026-08-04 · web `2026.07-unified.345` · Android `1.24.1`)
...
- **`.345`:** Status-warn soft chrome solidify; Loop 14 closed.
- **`.344`:** Active pad + readiness-delta extracts + wiring guards.
- **`.343`:** Seeded axe on Programs filter-miss EmptyState.
