...
## Now (2026-08-10 · web `2026.07-unified.645` · Android `1.24.1`)
...
- **`.645`:** (`2026.07-unified.645`) **Plan exercise why floors** — PlanExerciseLine uses coachWhyLine (same as adapt banner); no hydrate blank on catalogued whyKeys.
- **`.644`:** (`2026.07-unified.644`) **Today health chips + pillar labels** — CrossPillarCoachChips insight/action floors; PillarScoreBreakdown never paints raw keys.
- **`.643`:** (`2026.07-unified.643`) **Daily coach insight floors** — useDailyCoachInsight never paints raw message/action keys.
