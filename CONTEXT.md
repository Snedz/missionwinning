...
## Now (2026-08-12 · web `2026.07-unified.702` · Android `1.24.1`)
...
> and `.702` dropped `.669` detail (full text remains in LOG.md / archive)
...
- **`.702`:** (`2026.07-unified.702`) **Free Learn intro — offline Train + Coach** — Strength Basics `sb-0` first-run copy: offline diary log + Coach weeks from logs (F-001 / F-018); heroes still parked.
