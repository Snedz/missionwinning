...
## Now (2026-08-07 · web `2026.07-unified.572` · Android `1.24.1`)
...
- **`.572`:** Kaizen Profile/Coach/Bundle/Feedback hit targets.
- **`.571`:** Kaizen founder tool labels i18n + profile prefs plain.
