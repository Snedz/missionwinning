...
## Now (2026-08-13 · web `2026.07-unified.742` · Android `1.24.1`)
...
> and `.742` dropped `.636` detail (full text remains in LOG.md / archive)
...
- **`.742`:** (`2026.07-unified.742`) **Explore places stub** — `/explore` pin-board + optional nearby; quiet Account/More door; set logging stays place-blind (Decision 009; no gym wars).
