...
## Now (2026-08-14 · web `2026.07-unified.812` · Android `1.24.1`)
...
- **`.812`:** (`2026.07-unified.812`) **History first-paint** — title, count, empty, no-match match pack. Drift cap 210. No `PRIVATE_MODE` flip.
