...
## Now (2026-08-04 · web `2026.07-unified.348` · Android `1.24.1`)
...
- **`.348`:** Primary opacity chrome residue; Loop 15 closed.
- **`.347`:** Active `shouldShowVolumeTrimOffer` extract + wiring guard.
