...
- **`.729`:** (`2026.07-unified.729`) **Why this transparency report** — Account `/account/transparency` names logger / PRIVATE_MODE / region / Coach why-line / earn table / Super Bundle notify-until-Stripe; download JSON + text (same reasons). Occupied `.698`–`.728`.
