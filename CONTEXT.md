...
## Now (2026-08-12 · web `2026.07-unified.673` · Android `1.24.1`)
...
- **`.673`:** (`2026.07-unified.673`) **Dead alias redirects** — `/today`→`/log`, `/train`→`/active`, `/dashboard|/app`→`/log`, `/login|/pricing`→`/welcome`; `sanitizeNextPath` + private gate `?next=`; no pay surface.
