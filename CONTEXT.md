...
- **`.752`:** (`2026.07-unified.752`) **Mission Server messenger** — MSN rooms + local presence on `/server` (More → You). On-device persist; Realtime fail-open. Not Discord.com; not on Today/Train. Continues #518. Preview will not deploy.
