...
## Now (2026-08-10 · web `2026.07-unified.650` · Android `1.24.1`)
...
- **`.650`:** (`2026.07-unified.650`) **Badge count i18n** — Today rewards passes `n` for `{{n}} badges earned` (never raw `{{n}}` after first badge).
