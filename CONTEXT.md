...
## Now (2026-08-05 · web `2026.07-unified.495` · Android `1.24.1`)
...
- **`.495`:** SEO exercise → Train bridge (`/active?exercise=id`).
...
- **`.490`–`.474`:** i18n Unicode, next, free-beta, outdoor form residual.
