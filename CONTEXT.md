...
- **`.1067`:** (`2026.07-unified.1067`) **Dependabot leftovers batch** — `stripe` 22.6.2 (#921) + Playwright 1.63.0 (#923). Pin Stripe API `2026-08-26.dahlia`. Supersedes leftover Dependabot #919 #921 #922 #923. Skip #920 eslint 10 major. No Tailwind 4. Paper only. `[skip vercel]`. No promote. Live www stays `.697`. PRIVATE_MODE stays.
