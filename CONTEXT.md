...
- **`.694`:** (`2026.07-unified.694`) **Active set-table density (F-003)** — Strong/Hevy metric-first rows + dense ink `LogConsole`; sole poster-red Log set; kind/Use-next ink not accent-fill; ≥44px taps (one-thumb; not faster-than-Strong).
