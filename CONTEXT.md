...
## Now (2026-08-05 · web `2026.07-unified.489` · Android `1.24.1`)
...
- **`.489`:** next@16.3.0; public/locales pack parity; formPatterns pack media.
...
- **`.483`–`.474`:** Set ordinal, outdoor set-kind, form media/loops, Form Director residual.
