...
## Now (2026-08-04 · web `2026.07-unified.358` · Android `1.24.1`)
...
- **`.358`:** Seeded axe on plate calculator; Plates aria-label on mobile.
- **`.357`:** Mind check-in note chrome solidify; Loop 18 closed.
- **`.356`:** Active `activeSessionHasExercises` extract + wiring guard.
