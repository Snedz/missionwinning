...
- **`.879`:** (`2026.07-unified.879`) **Week One looked like a warning** — the badge SVG was a closed triangle; at 32px on Victory it read as a broken-image icon. Three session bars now (two ink, last red). Guard kills the old path. No `PRIVATE_MODE` flip.
