...
> and `.699` dropped `.669` detail (full text remains in LOG.md / archive)
...
- **`.699`:** (`2026.07-unified.699`) **Free Learn intro — offline Train + Coach** — Strength Basics `sb-0` first-run copy: offline diary log + Coach weeks from logs (F-001 / F-018); heroes still parked.
