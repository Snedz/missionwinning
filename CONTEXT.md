...
- **`.699`:** (`2026.07-unified.699`) **Coach why-this-session** — boss-card log-cited rationale (inputs · rule · effect) from recent logs; Coach opt-in only (F-012 / F-002-session; after `.693` week).
