...
## Now (2026-08-13 · web `2026.07-unified.704` · Android `1.24.1`)
...
> and `.704` dropped `.689` detail (full text remains in LOG.md / archive)
...
- **`.704`:** (`2026.07-unified.704`) **Legal + About 0.1 / Texas LLC stamp** — About = Mission Winning 0.1 (beta) open beta; Mission Winning LLC, a Texas limited liability company; legal Last updated 13 August 2026; refunds honest while FREE_BETA (not legal advice).
...
- **Free-first beta (~4 weeks):** Texas LLC formed + EIN issued — **no Bundle UI** + **full depth unlocked**; Stripe business account pending; More/rail **Pillars demoted until first workout** (F-004 / `.695`) — still no Bundle ([docs/FREE_BETA.md](docs/FREE_BETA.md)).
