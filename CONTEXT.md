...
## Now (2026-08-10 · web `2026.07-unified.656` · Android `1.24.1`)
...
- **`.653`:** (`2026.07-unified.653`) **Legal English floors** — Regions/Service-Terms never paint raw info* keys on first paint.
