...
## Now (2026-08-13 · web `2026.07-unified.726` · Android `1.24.1`)
...
> and `.726` dropped `.636` detail (full text remains in LOG.md / archive)
...
- **`.726`:** (`2026.07-unified.726`) **Mission Server v1 garage text rooms** — `/server` (More → You, not a tab); one local Garage; channels `train` / `garage` / `off-topic`; optional Realtime fail-closed. Founder override 2026-08-13; parkable L2; not Friday’s pitch.
