...
## Now (2026-08-05 · web `2026.07-unified.490` · Android `1.24.1`)
...
- **`.490`:** Unicode pack placeholder guard (hi/vi/th `{{गिनती}}` etc. → English keys).
...
- **`.485`–`.474`:** Rest outdoor glance, locale keys, set ordinal, form media residual.
