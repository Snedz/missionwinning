...
- **`.1070`:** (`2026.07-unified.1070`) **Coverage floor 438 → 493 + i18n + bundle HOLD** — Floor 493 after #935. Four catalog keys. Bundle caps to CI measured ceil (`/` 459 reconstructed, `/log` 417, `/active` 511). `Alpha` allowlisted. No invented tests. No TodayDesk craft. Paper only. `[skip vercel]`. No tip-promote. Live www stays `.697`. PRIVATE_MODE stays.
