...
## Now (2026-08-13 · web `2026.07-unified.737` · Android `1.24.1`)
...
> and `.737` dropped `.636` detail (full text remains in LOG.md / archive)
...
- **`.737`:** (`2026.07-unified.737`) **Global first-visit language + country** — 40-row language picker; country list is `isHostedServiceSupportedCountry` only; language ≠ market; geo-block wins for hosted signup/checkout. Excellence-Override (RESULT unscored).
