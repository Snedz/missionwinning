...
> and `.712` dropped `.689` detail (full text remains in LOG.md / archive)
...
- **`.712`:** (`2026.07-unified.712`) **Victory vs-last receipt** — after Finish: Duration · Volume · Sets, Set · Prev · Load · vs last, beaten PRs from local logs (instant, offline, free; Hevy receipt bar). No Feed / share-to-unlock.
