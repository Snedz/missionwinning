...
> and `.671` dropped `.668` detail (full text remains in LOG.md / archive)
...
- **`.671`:** (`2026.07-unified.671`) **PWA start_url gate-public** — cold install opens `/private` not gated `/log`; `id` unchanged.
