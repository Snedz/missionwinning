...
## Now (2026-08-05 · web `2026.07-unified.524` · Android `1.24.1`)
...
> and `.505`–`.524` dropped detail (full text remains in LOG.md / archive)
...
- **`.524`–`.515`:** badge desc EN · HistoryDay formatLocalDateKey · WhatsNew · Profile challenges · perfect_week.
