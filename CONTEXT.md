...
## Now (2026-08-05 · web `2026.07-unified.530` · Android `1.24.1`)
...
> and `.505`–`.530` dropped detail (full text remains in LOG.md / archive)
...
- **`.530`–`.515`:** journal when + fuel clock · Today header · analytics · nutrition merge · formatLocal* · perfect_week.
