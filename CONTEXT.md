...
## Now (2026-08-05 · web `2026.07-unified.519` · Android `1.24.1`)
...
> and `.505`–`.519` dropped detail (full text remains in LOG.md / archive)
...
- **`.519`–`.515`:** volume helper · re-entry shame-free · EN ranks · perfect_week paths. re-entry shame-free pin · EN ranks/badges · perfect_week paths. EN ranks/badges + challenge XP catalog + perfect_week fuel/pillar paths. challenge XP catalog SoT + perfect_week fuel/pillar paths.
