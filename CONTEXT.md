...
## Now (2026-08-12 · web `2026.07-unified.676` · Android `1.24.1`)
...
- **`.676`:** (`2026.07-unified.676`) **Honest offline meta when SW gated** — manifest + root OG/Twitter + landing JSON-LD + `/beta` metadata gate on `isOfflineInstallable()`; no PRIVATE_MODE flip.
