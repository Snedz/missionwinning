...
## Now (2026-08-12 · web `2026.07-unified.680` · Android `1.24.1`)
...
- **`.680`:** (`2026.07-unified.680`) **Units + BW Victory volume** — sync metric default (no geo-imperial); Victory reps when tonnage is 0.
