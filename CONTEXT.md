...
## Now (2026-08-09 · web `2026.07-unified.634` · Android `1.24.1`)
...
- **`.634`:** (`2026.07-unified.634`) **Sanctions/export** name occupied UA regions (Crimea, Donetsk, Luhansk, Kherson, Zaporizhzhia) across Terms/Regions/AUP. **Not legal advice.**
...
- **`.618`:** (`2026.07-unified.618`) **Ukraine commercial exclusion** + consumer legal refresh — Terms sanctions clause (occupied UA regions named in `.634`); Regions/Privacy/AUP/Service-Terms/Refunds; `UA` hard-block. Not OFAC country embargo; RU/BY still open (founder). Counsel export 2026-08-09. **Not legal advice.**
