...
## Now (2026-07-23 · web `2026.07-unified.116` · Android `1.24.1`)
...
- **Ops:** promote **`.116`** (PKCE cookies); **founder: Supabase Site URL = `https://www.missionwinning.com`** (not `*.vercel.app`).
- Shipped: `.116` @supabase/ssr OAuth callback; prior `.115` canonical host. **Founder:** phone excellence pass/fail before ≥10 beta.
