...
- **`.947`:** (`2026.07-unified.947`) **Hevy English CSV import** — same Account path as Strong. Headers are set-table-a, not Strong. Preview + confirm. Empty / one / malformed. Skipped rows counted. More than one file. Guest path. No `PRIVATE_MODE` flip.
