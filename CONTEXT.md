...
## Now (2026-08-04 · web `2026.07-unified.464` · Android `1.24.1`)
...
> and `.462` dropped `.444` detail (full text remains in LOG.md / archive)
> and `.463` dropped `.450` detail (full text remains in LOG.md / archive)
> and `.464` dropped `.451` detail (full text remains in LOG.md / archive)
...
- **`.464`:** (`2026.07-unified.464`) About/Vision rebuilt on `PublicPageShell` (marketing chrome, editorial bodies, existing copy) + JoinClass branded shell and error path.
- **`.463`:** (`2026.07-unified.463`) App voice recut — PillarPageHeader display type (~30 screens), weight sweep + ratchet, Track onto `card-section` + `ScoreNumeral`, Learn/Mind/Move idiom unification, `/experience` retired, design guard walks `.css`.
...
- **`.458`:** Craft blurbs + 15 structured form guides (51→66 coverage).
