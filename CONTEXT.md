...
## Now (2026-08-13 · web `2026.07-unified.701` · Android `1.24.1`)
...
> and `.701` dropped `.636` detail (full text remains in LOG.md / archive)
...
- **`.701`:** (`2026.07-unified.701`) **Exquisite gated www** — four cinematic scenes on `/private` + post-unlock `/`. Constitution-first (`docs/design/WWW_NIGHT.md` §0). SET is a full-viewport LOG SET field. Cover: Train Anywhere. Win Daily. / Log a set. Offline. / one quiet Coach line (L1 on fold 1). Order SET → Anywhere → Week → Door. HUD nav. Quiet L2 after the door (athlete page you author; not a feed). One red LOG SET; door stays paper. CTA pack Free beta / Enter with code / Get notified. Draft; no Preview. [docs/design/WWW_NIGHT.md](docs/design/WWW_NIGHT.md).
