...
- **`.698`:** (`2026.07-unified.698`) **Gated www honesty (F-008)** — invite/private-beta framing on `/private` + Welcome; Train→Coach teaser; no opaque sign-in spinner / false open-beta; `/`+`/log` stay gate redirects.
