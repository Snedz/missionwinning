...
- **`.703`:** (`2026.07-unified.703`) **F-013 smart defaults** — next set dial prefills last load/reps (prescribed + freestyle); one ≥44px Log set confirm. Does not rewrite the set table (E-Adjacency).
