...
## Now (2026-08-07 · web `2026.07-unified.570` · Android `1.24.1`)
...
- **`.570`:** Fix assessment win bumps streak; assess CTAs plain.
- **`.569`:** Kaizen Profile/military i18n hard-English kill.
- **`.568`:** Fix kill alert() cheerleading on Today founder tools + Profile owner.
- **`.567`:** Fix empty-state exits (Fuel recipes, Benchmarks, LB squad).
- **`.566`:** Kaizen CTA arrows off Today/coach/public + Welcome 52px.
- **`.565`:** Kaizen Builder/LB/PFT/guidebook plain muted residual.
- **`.564`:** Kaizen photo meal + adapt/day-review muted chrome.
- **`.563`:** Kaizen ExercisePicker muted select + Fuel/Track chip wash.
- **`.562`:** Kaizen Today plain links + chrome muted hover + 44px chips.
