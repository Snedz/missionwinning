...
> and `.746` dropped `.636` detail (full text remains in LOG.md / archive)
...
- **`.746`:** (`2026.07-unified.746`) **Pregnancy + miscarriage safety (counsel-hold)** — optional athlete-owned flag; Coach cannot prescribe a load jump; max-effort CTAs hidden; not prenatal care. Draft until counsel reviews copy.
