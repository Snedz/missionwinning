...
- **`.698`:** (`2026.07-unified.698`) **Victory Move seam (S6)** — one secondary line deep-links a free flow for muscles just trained; skip fuel if both would show; no Move tab / score / video library.
