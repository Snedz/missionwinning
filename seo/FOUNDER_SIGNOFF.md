...
## Before calculator SEO push (pages already public)

- [ ] Confirm indexation + canonicals on `/calculators/1rm`, `/calculators/tdee`, `/calculators/strength-standards`
- [ ] Soft CTA to `/welcome` (no-account logger) + Coach — no wearable requirement claims
- [ ] Do not invent usage metrics on calculator pages
