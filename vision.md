...
2. **AI Coach / Workout Generator** — Personalized plans based on goals, schedule, fatigue
3. **Strength Builder** — Robust exercise library, set/reps/weight logger, real-time feedback
4. **Progress Tracking** — Volume, strength progression, charts, streaks
...
- Workout tracking (the core mission) is 100% free, forever.
- Basic exercise library (bodyweight/minimal-equipment focused, global-friendly).
- Basic nutrition logging and accessible recipes.
- Basic assessments, streaks, challenges, and habit tools.
- Community elements and progress visibility.
- Full PWA experience: installable, offline-first, low-data, works on any device/browser anywhere (Lagos, Moscow, Mumbai, rural areas, parks, homes).
...
- **The Right Path vs. Destruction**: Evidence-based (roots in real certification materials like ISSA + science/M&S scale, no fads or hype). Holistic (synergy across pillars beats siloed tools). Habit- and consistency-focused (streaks, readiness, challenges). Truth-telling: Explicitly guide users toward the building path and away from average/excuse/destructive ones.
- **Mission Over Pure Profit**: "Mainly a free app." Revenue sustains the mission, owner compensation, and scaling — but vision is primary. Measure by users reached, sessions, global equity, health stories/outcomes + sustainable finances.
- **Synergy & the Everything App**: Pillars are designed to reinforce (mobility improves training; mind improves adherence; nutrition fuels results). Bundle as the "one app for whole self."
- **Quality, Scale & Originality**: Free basics are excellent (not crippled). Premium is world-class. Content seeded from deep research (ISSA PDFs for authentic cues/recipes/programs + M&S for scale/filters) — original wording, globalized, no direct copies or branding mentions.
- **Global & Inclusive**: For everyone. "Train anywhere. Win daily." No US/America reliance. Impact in underserved regions via PWA + future Foundation scholarships (free premium access).
...
- **Equity & Reach**: Strong presence in global south/low-resource areas. Foundation arm provides scholarships.
- **Long-Term**: Vision.md as living document (annual review). "The path" becomes cultural shorthand for evidence-based, accessible, synergistic health.

## "We Don't Want to Go the Way to Destruction"
This is explicit. Mission Winning is not neutral. It stands for the *right way*: consistent, holistic, accessible, science-rooted habits that build people up. It calls out (gently but clearly) the alternatives — excuses, average mediocrity, gated "elite only" systems that exclude most of the world, quick fixes that lead to burnout or harm. The app is the guide, the tracker, the teacher, the community, and the bundle of tools that make the right path obvious, doable, and synergistic for anyone.

Free core delivers the mission immediately. Premium + Super Bundle make the full journey deeper, faster, and more sustainable — for those ready, while funding access for all.
...
- **Revenue Ethics**: Freemium + bundles for sustainability. No gating the mission. Hybrid structure (LLC for ops + optional Foundation for scholarships/impact).
- **Measure What Matters**: Users impacted, global sessions, bundle conversion, retention via synergy, stories from free users.

This vision is the filter for every decision. If it doesn't serve free global accessibility or the right path, we don't do it. Premium and bundles exist to make the mission bigger and more sustainable — not to limit it.

**Mission Winning: Free for the world. The everything app for health. The path forward.**

**Planning:** [PLAN.md](PLAN.md) · **Vision scorecard:** [VISION_STATUS.md](VISION_STATUS.md) · **Rural & offline:** [RURAL_EQUITY_PLAN.md](RURAL_EQUITY_PLAN.md)
