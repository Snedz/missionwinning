...
| **Which loop runs next** | `npm run harness` — names the row, the route and the recipe; recipe 14. Empty queue + empty harvest → path (15), then vision gauntlet (`docs/gauntlet/VISION.md`, recipe 12). Start: `/harness` or `/harness 2 hours` |
